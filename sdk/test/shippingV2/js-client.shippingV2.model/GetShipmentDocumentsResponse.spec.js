...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetShipmentDocumentsResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetShipmentDocumentsResponse();
      });

      it('should create an instance of GetShipmentDocumentsResponse', function() {
        // TODO: update the code to test GetShipmentDocumentsResponse
