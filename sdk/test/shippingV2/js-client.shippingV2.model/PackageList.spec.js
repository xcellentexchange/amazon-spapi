...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('PackageList', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.PackageList();
      });

      it('should create an instance of PackageList', function() {
        // TODO: update the code to test PackageList
        expect(instance).to.be.a(AmazonShippingApi.PackageList);
      });
