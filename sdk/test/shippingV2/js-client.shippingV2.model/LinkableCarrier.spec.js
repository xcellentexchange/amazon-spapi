...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('LinkableCarrier', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.LinkableCarrier();
      });

      it('should create an instance of LinkableCarrier', function() {
        // TODO: update the code to test LinkableCarrier
      ...
      it('should have the property linkableAccountTypes (base name: "linkableAccountTypes")', function() {
        // TODO: update the code to test the property linkableAccountTypes
        expect(instance).to.have.property('linkableAccountTypes');
        // expect(instance.linkableAccountTypes).to.be(expectedValueLiteral);
      });
