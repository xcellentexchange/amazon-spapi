  ...
  describe('shippingV2', function() {
    describe('CollectionsFormDocument', function() {
      ...
      it('should create an instance of CollectionsFormDocument', function() {
        // TODO: update the code to test CollectionsFormDocument
      ...
      it('should have the property base64EncodedContent (base name: "base64EncodedContent")', function() {
        // TODO: update the code to test the property base64EncodedContent
        expect(instance).to.have.property('base64EncodedContent');
        // expect(instance.base64EncodedContent).to.be(expectedValueLiteral);
      });
