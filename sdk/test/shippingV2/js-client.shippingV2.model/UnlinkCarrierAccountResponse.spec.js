...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('UnlinkCarrierAccountResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.UnlinkCarrierAccountResponse();
      });

      it('should create an instance of UnlinkCarrierAccountResponse', function() {
        // TODO: update the code to test UnlinkCarrierAccountResponse
      ...
      it('should have the property isUnlinked (base name: "isUnlinked")', function() {
        // TODO: update the code to test the property isUnlinked
        expect(instance).to.have.property('isUnlinked');
        // expect(instance.isUnlinked).to.be(expectedValueLiteral);
      });
