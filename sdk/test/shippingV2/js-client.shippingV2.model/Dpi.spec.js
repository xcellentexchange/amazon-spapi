...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('Dpi', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.Dpi();
      });

      it('should create an instance of Dpi', function() {
        // TODO: update the code to test Dpi
        expect(instance).to.be.a(AmazonShippingApi.Dpi);
      });
