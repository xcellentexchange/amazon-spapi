...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetCollectionFormHistoryResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetCollectionFormHistoryResponse();
      });

      it('should create an instance of GetCollectionFormHistoryResponse', function() {
        // TODO: update the code to test GetCollectionFormHistoryResponse
      ...
      it('should have the property collectionFormsHistoryRecordList (base name: "collectionFormsHistoryRecordList")', function() {
        // TODO: update the code to test the property collectionFormsHistoryRecordList
        expect(instance).to.have.property('collectionFormsHistoryRecordList');
        // expect(instance.collectionFormsHistoryRecordList).to.be(expectedValueLiteral);
      });

      it('should have the property lastRefreshedDate (base name: "lastRefreshedDate")', function() {
        // TODO: update the code to test the property lastRefreshedDate
        expect(instance).to.have.property('lastRefreshedDate');
        // expect(instance.lastRefreshedDate).to.be(expectedValueLiteral);
      });
