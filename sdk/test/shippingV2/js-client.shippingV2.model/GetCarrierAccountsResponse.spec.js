...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetCarrierAccountsResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetCarrierAccountsResponse();
      });

      it('should create an instance of GetCarrierAccountsResponse', function() {
        // TODO: update the code to test GetCarrierAccountsResponse
      ...
      it('should have the property activeAccounts (base name: "activeAccounts")', function() {
        // TODO: update the code to test the property activeAccounts
        expect(instance).to.have.property('activeAccounts');
        // expect(instance.activeAccounts).to.be(expectedValueLiteral);
      });
