...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetUnmanifestedShipmentsRequest', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetUnmanifestedShipmentsRequest();
      });

      it('should create an instance of GetUnmanifestedShipmentsRequest', function() {
        // TODO: update the code to test GetUnmanifestedShipmentsRequest
