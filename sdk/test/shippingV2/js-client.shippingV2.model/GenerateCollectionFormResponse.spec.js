...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GenerateCollectionFormResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GenerateCollectionFormResponse();
      });

      it('should create an instance of GenerateCollectionFormResponse', function() {
        // TODO: update the code to test GenerateCollectionFormResponse
      ...
      it('should have the property collectionsFormDocument (base name: "collectionsFormDocument")', function() {
        // TODO: update the code to test the property collectionsFormDocument
        expect(instance).to.have.property('collectionsFormDocument');
        // expect(instance.collectionsFormDocument).to.be(expectedValueLiteral);
      });
