  ...
  describe('shippingV2', function() {
    describe('UnmanifestedShipmentLocation', function() {
      ...
      it('should create an instance of UnmanifestedShipmentLocation', function() {
        // TODO: update the code to test UnmanifestedShipmentLocation
      ...
      it('should have the property lastManifestDate (base name: "lastManifestDate")', function() {
        // TODO: update the code to test the property lastManifestDate
        expect(instance).to.have.property('lastManifestDate');
        // expect(instance.lastManifestDate).to.be(expectedValueLiteral);
      });
