...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('ValueAddedServiceDetails', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.ValueAddedServiceDetails();
      });

      it('should create an instance of ValueAddedServiceDetails', function() {
        // TODO: update the code to test ValueAddedServiceDetails
      ...
      it('should have the property collectOnDelivery (base name: "collectOnDelivery")', function() {
        // TODO: update the code to test the property collectOnDelivery
        expect(instance).to.have.property('collectOnDelivery');
        // expect(instance.collectOnDelivery).to.be(expectedValueLiteral);
      });
