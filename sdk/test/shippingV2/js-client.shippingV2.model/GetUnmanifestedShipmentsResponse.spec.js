...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetUnmanifestedShipmentsResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetUnmanifestedShipmentsResponse();
      });

      it('should create an instance of GetUnmanifestedShipmentsResponse', function() {
        // TODO: update the code to test GetUnmanifestedShipmentsResponse
      ...
      it('should have the property unmanifestedCarrierInformationList (base name: "unmanifestedCarrierInformationList")', function() {
        // TODO: update the code to test the property unmanifestedCarrierInformationList
        expect(instance).to.have.property('unmanifestedCarrierInformationList');
        // expect(instance.unmanifestedCarrierInformationList).to.be(expectedValueLiteral);
      });
