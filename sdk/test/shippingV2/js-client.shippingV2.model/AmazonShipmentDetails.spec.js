...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('AmazonShipmentDetails', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.AmazonShipmentDetails();
      });

      it('should create an instance of AmazonShipmentDetails', function() {
        // TODO: update the code to test AmazonShipmentDetails
