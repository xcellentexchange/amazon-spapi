...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetAccessPointsResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetAccessPointsResponse();
      });

      it('should create an instance of GetAccessPointsResponse', function() {
        // TODO: update the code to test GetAccessPointsResponse
