...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetShipmentDocumentsResult', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetShipmentDocumentsResult();
      });

      it('should create an instance of GetShipmentDocumentsResult', function() {
        // TODO: update the code to test GetShipmentDocumentsResult
      ...
      it('should have the property packageDocumentDetail (base name: "packageDocumentDetail")', function() {
        // TODO: update the code to test the property packageDocumentDetail
        expect(instance).to.have.property('packageDocumentDetail');
        // expect(instance.packageDocumentDetail).to.be(expectedValueLiteral);
      });
