...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('UnlinkCarrierAccountRequest', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.UnlinkCarrierAccountRequest();
      });

      it('should create an instance of UnlinkCarrierAccountRequest', function() {
        // TODO: update the code to test UnlinkCarrierAccountRequest
