...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('Contents', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.Contents();
      });

      it('should create an instance of Contents', function() {
        // TODO: update the code to test Contents
        expect(instance).to.be.a(AmazonShippingApi.Contents);
      });
