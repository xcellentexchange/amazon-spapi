...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetCarrierAccountsRequest', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetCarrierAccountsRequest();
      });

      it('should create an instance of GetCarrierAccountsRequest', function() {
        // TODO: update the code to test GetCarrierAccountsRequest
