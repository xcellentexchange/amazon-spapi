...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('OneClickShipmentValueAddedService', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.OneClickShipmentValueAddedService();
      });

      it('should create an instance of OneClickShipmentValueAddedService', function() {
        // TODO: update the code to test OneClickShipmentValueAddedService
