...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('DirectPurchaseResult', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.DirectPurchaseResult();
      });

      it('should create an instance of DirectPurchaseResult', function() {
        // TODO: update the code to test DirectPurchaseResult
      ...
      it('should have the property packageDocumentDetailList (base name: "packageDocumentDetailList")', function() {
        // TODO: update the code to test the property packageDocumentDetailList
        expect(instance).to.have.property('packageDocumentDetailList');
        // expect(instance.packageDocumentDetailList).to.be(expectedValueLiteral);
      });
