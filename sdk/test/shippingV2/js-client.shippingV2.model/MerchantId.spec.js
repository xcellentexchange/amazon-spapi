...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('MerchantId', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.MerchantId();
      });

      it('should create an instance of MerchantId', function() {
        // TODO: update the code to test MerchantId
        expect(instance).to.be.a(AmazonShippingApi.MerchantId);
      });
