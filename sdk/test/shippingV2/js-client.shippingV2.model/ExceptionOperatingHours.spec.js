...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('ExceptionOperatingHours', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.ExceptionOperatingHours();
      });

      it('should create an instance of ExceptionOperatingHours', function() {
        // TODO: update the code to test ExceptionOperatingHours
      ...
      it('should have the property operatingHours (base name: "operatingHours")', function() {
        // TODO: update the code to test the property operatingHours
        expect(instance).to.have.property('operatingHours');
        // expect(instance.operatingHours).to.be(expectedValueLiteral);
      });
