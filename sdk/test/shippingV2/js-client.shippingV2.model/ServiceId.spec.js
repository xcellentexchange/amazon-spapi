...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('ServiceId', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.ServiceId();
      });

      it('should create an instance of ServiceId', function() {
        // TODO: update the code to test ServiceId
        expect(instance).to.be.a(AmazonShippingApi.ServiceId);
      });
