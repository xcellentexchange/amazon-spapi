...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('RequestToken', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.RequestToken();
      });

      it('should create an instance of RequestToken', function() {
        // TODO: update the code to test RequestToken
        expect(instance).to.be.a(AmazonShippingApi.RequestToken);
      });
