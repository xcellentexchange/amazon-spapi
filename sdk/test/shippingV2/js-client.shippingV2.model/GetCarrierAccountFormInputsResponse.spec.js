...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('GetCarrierAccountFormInputsResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.GetCarrierAccountFormInputsResponse();
      });

      it('should create an instance of GetCarrierAccountFormInputsResponse', function() {
        // TODO: update the code to test GetCarrierAccountFormInputsResponse
      ...
      it('should have the property linkableCarriersList (base name: "linkableCarriersList")', function() {
        // TODO: update the code to test the property linkableCarriersList
        expect(instance).to.have.property('linkableCarriersList');
        // expect(instance.linkableCarriersList).to.be(expectedValueLiteral);
      });
