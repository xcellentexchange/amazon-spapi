...
(function(root, factory) {
  ...
  describe('shippingV2', function() {
    describe('LinkCarrierAccountResponse', function() {
      beforeEach(function() {
        instance = new AmazonShippingApi.LinkCarrierAccountResponse();
      });

      it('should create an instance of LinkCarrierAccountResponse', function() {
        // TODO: update the code to test LinkCarrierAccountResponse
      ...
      it('should have the property registrationStatus (base name: "registrationStatus")', function() {
        // TODO: update the code to test the property registrationStatus
        expect(instance).to.have.property('registrationStatus');
        // expect(instance.registrationStatus).to.be(expectedValueLiteral);
      });
