...
(function(root, factory) {
  ...
  describe('productPricingV0', function() {
    describe('BatchOffersRequestParams', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.BatchOffersRequestParams();
      });

      it('should create an instance of BatchOffersRequestParams', function() {
        // TODO: update the code to test BatchOffersRequestParams
