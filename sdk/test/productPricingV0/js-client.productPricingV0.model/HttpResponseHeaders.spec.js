  ...
  describe('productPricingV0', function() {
    describe('HttpResponseHeaders', function() {
      ...
      it('should create an instance of HttpResponseHeaders', function() {
        // TODO: update the code to test HttpResponseHeaders
      ...
      it('should have the property xAmznRequestId (base name: "x-amzn-RequestId")', function() {
        // TODO: update the code to test the property xAmznRequestId
        expect(instance).to.have.property('xAmznRequestId');
        // expect(instance.xAmznRequestId).to.be(expectedValueLiteral);
      });
