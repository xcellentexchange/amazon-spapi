...
(function(root, factory) {
  ...
  describe('productPricingV0', function() {
    describe('ListingOffersRequestParams', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.ListingOffersRequestParams();
      });

      it('should create an instance of ListingOffersRequestParams', function() {
        // TODO: update the code to test ListingOffersRequestParams
