...
(function(root, factory) {
  ...
  describe('productPricingV0', function() {
    describe('GetListingOffersBatchRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.GetListingOffersBatchRequest();
      });

      it('should create an instance of GetListingOffersBatchRequest', function() {
        // TODO: update the code to test GetListingOffersBatchRequest
