...
(function(root, factory) {
  ...
  describe('productPricingV0', function() {
    describe('ListingOffersResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.ListingOffersResponse();
      });

      it('should create an instance of ListingOffersResponse', function() {
        // TODO: update the code to test ListingOffersResponse
