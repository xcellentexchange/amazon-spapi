...
(function(root, factory) {
  ...
  describe('productPricingV0', function() {
    describe('FulfillmentChannelType', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForPricing.FulfillmentChannelType;
      });

      it('should create an instance of FulfillmentChannelType', function() {
        // TODO: update the code to test FulfillmentChannelType
      ...
      it('should have the property merchant', function() {
        expect(instance).to.have.property('merchant');
        expect(instance.merchant).to.be("Merchant");
      });
