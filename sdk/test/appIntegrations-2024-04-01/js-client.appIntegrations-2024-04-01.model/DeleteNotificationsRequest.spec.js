  ...
  describe('appIntegrations-2024-04-01', function() {
    describe('DeleteNotificationsRequest', function() {
      ...
      it('should create an instance of DeleteNotificationsRequest', function() {
        // TODO: update the code to test DeleteNotificationsRequest
      ...
      it('should have the property deletionReason (base name: "deletionReason")', function() {
        // TODO: update the code to test the property deletionReason
        expect(instance).to.have.property('deletionReason');
        // expect(instance.deletionReason).to.be(expectedValueLiteral);
      });
