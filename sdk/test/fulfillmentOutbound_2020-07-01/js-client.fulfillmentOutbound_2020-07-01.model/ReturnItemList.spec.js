...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('ReturnItemList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.ReturnItemList();
      });

      it('should create an instance of ReturnItemList', function() {
        // TODO: update the code to test ReturnItemList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.ReturnItemList);
      });
