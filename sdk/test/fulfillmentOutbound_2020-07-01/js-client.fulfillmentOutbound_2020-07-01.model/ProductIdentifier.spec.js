...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('ProductIdentifier', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.ProductIdentifier();
      });

      it('should create an instance of ProductIdentifier', function() {
        // TODO: update the code to test ProductIdentifier
      ...
      it('should have the property merchantSku (base name: "merchantSku")', function() {
        // TODO: update the code to test the property merchantSku
        expect(instance).to.have.property('merchantSku');
        // expect(instance.merchantSku).to.be(expectedValueLiteral);
      });
