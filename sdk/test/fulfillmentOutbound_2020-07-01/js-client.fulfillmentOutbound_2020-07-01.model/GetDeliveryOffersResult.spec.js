...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('GetDeliveryOffersResult', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersResult();
      });

      it('should create an instance of GetDeliveryOffersResult', function() {
        // TODO: update the code to test GetDeliveryOffersResult
      ...
      it('should have the property deliveryOffers (base name: "deliveryOffers")', function() {
        // TODO: update the code to test the property deliveryOffers
        expect(instance).to.have.property('deliveryOffers');
        // expect(instance.deliveryOffers).to.be(expectedValueLiteral);
      });
