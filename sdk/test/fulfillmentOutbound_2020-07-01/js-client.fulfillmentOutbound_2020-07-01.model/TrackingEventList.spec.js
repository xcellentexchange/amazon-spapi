...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('TrackingEventList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.TrackingEventList();
      });

      it('should create an instance of TrackingEventList', function() {
        // TODO: update the code to test TrackingEventList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.TrackingEventList);
      });
