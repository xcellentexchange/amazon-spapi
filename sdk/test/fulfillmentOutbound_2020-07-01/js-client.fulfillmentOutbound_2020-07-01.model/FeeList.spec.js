...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('FeeList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.FeeList();
      });

      it('should create an instance of FeeList', function() {
        // TODO: update the code to test FeeList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.FeeList);
      });
