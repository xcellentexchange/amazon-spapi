...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('NotificationEmailList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.NotificationEmailList();
      });

      it('should create an instance of NotificationEmailList', function() {
        // TODO: update the code to test NotificationEmailList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.NotificationEmailList);
      });
