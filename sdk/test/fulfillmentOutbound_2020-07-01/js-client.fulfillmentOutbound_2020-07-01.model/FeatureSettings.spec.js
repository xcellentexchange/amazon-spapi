  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('FeatureSettings', function() {
      ...
      it('should create an instance of FeatureSettings', function() {
        // TODO: update the code to test FeatureSettings
      ...
      it('should have the property featureFulfillmentPolicy (base name: "featureFulfillmentPolicy")', function() {
        // TODO: update the code to test the property featureFulfillmentPolicy
        expect(instance).to.have.property('featureFulfillmentPolicy');
        // expect(instance.featureFulfillmentPolicy).to.be(expectedValueLiteral);
      });
