...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('StringList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.StringList();
      });

      it('should create an instance of StringList', function() {
        // TODO: update the code to test StringList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.StringList);
      });
