...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('ReasonCodeDetailsList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.ReasonCodeDetailsList();
      });

      it('should create an instance of ReasonCodeDetailsList', function() {
        // TODO: update the code to test ReasonCodeDetailsList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.ReasonCodeDetailsList);
      });
