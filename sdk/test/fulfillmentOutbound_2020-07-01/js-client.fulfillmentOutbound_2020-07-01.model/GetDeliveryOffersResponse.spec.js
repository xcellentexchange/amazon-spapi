...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('GetDeliveryOffersResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersResponse();
      });

      it('should create an instance of GetDeliveryOffersResponse', function() {
        // TODO: update the code to test GetDeliveryOffersResponse
