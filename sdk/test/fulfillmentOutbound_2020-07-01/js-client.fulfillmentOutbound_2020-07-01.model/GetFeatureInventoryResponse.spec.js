...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('GetFeatureInventoryResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.GetFeatureInventoryResponse();
      });

      it('should create an instance of GetFeatureInventoryResponse', function() {
        // TODO: update the code to test GetFeatureInventoryResponse
