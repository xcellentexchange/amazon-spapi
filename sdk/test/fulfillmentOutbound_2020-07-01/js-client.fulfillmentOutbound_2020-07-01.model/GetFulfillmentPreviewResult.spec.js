  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('GetFulfillmentPreviewResult', function() {
      ...
      it('should create an instance of GetFulfillmentPreviewResult', function() {
        // TODO: update the code to test GetFulfillmentPreviewResult
      ...
      it('should have the property fulfillmentPreviews (base name: "fulfillmentPreviews")', function() {
        // TODO: update the code to test the property fulfillmentPreviews
        expect(instance).to.have.property('fulfillmentPreviews');
        // expect(instance.fulfillmentPreviews).to.be(expectedValueLiteral);
      });
