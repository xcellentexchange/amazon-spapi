...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('DeliveryWindowList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.DeliveryWindowList();
      });

      it('should create an instance of DeliveryWindowList', function() {
        // TODO: update the code to test DeliveryWindowList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.DeliveryWindowList);
      });
