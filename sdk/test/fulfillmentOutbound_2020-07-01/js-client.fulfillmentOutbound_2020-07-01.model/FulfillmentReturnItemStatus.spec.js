...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('FulfillmentReturnItemStatus', function() {
      beforeEach(function() {
        instance = SellingPartnerApisForFulfillmentOutbound.FulfillmentReturnItemStatus;
      });

      it('should create an instance of FulfillmentReturnItemStatus', function() {
        // TODO: update the code to test FulfillmentReturnItemStatus
      ...
      it('should have the property processed', function() {
        expect(instance).to.have.property('processed');
        expect(instance.processed).to.be("Processed");
      });
