...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('DeliveryDocumentList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.DeliveryDocumentList();
      });

      it('should create an instance of DeliveryDocumentList', function() {
        // TODO: update the code to test DeliveryDocumentList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.DeliveryDocumentList);
      });
