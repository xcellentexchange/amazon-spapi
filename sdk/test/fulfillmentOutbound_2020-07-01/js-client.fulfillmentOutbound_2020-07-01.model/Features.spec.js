...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('Features', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.Features();
      });

      it('should create an instance of Features', function() {
        // TODO: update the code to test Features
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.Features);
      });
