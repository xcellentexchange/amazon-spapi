  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('Feature', function() {
      ...
      it('should have the property featureDescription (base name: "featureDescription")', function() {
        // TODO: update the code to test the property featureDescription
        expect(instance).to.have.property('featureDescription');
        // expect(instance.featureDescription).to.be(expectedValueLiteral);
      });

      it('should have the property sellerEligible (base name: "sellerEligible")', function() {
        // TODO: update the code to test the property sellerEligible
        expect(instance).to.have.property('sellerEligible');
        // expect(instance.sellerEligible).to.be(expectedValueLiteral);
      });
