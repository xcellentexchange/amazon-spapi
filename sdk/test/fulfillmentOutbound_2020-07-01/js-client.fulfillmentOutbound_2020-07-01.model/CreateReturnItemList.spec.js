...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('CreateReturnItemList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.CreateReturnItemList();
      });

      it('should create an instance of CreateReturnItemList', function() {
        // TODO: update the code to test CreateReturnItemList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.CreateReturnItemList);
      });
