  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('ScheduledDeliveryInfo', function() {
      ...
      it('should create an instance of ScheduledDeliveryInfo', function() {
        // TODO: update the code to test ScheduledDeliveryInfo
      ...
      it('should have the property deliveryTimeZone (base name: "deliveryTimeZone")', function() {
        // TODO: update the code to test the property deliveryTimeZone
        expect(instance).to.have.property('deliveryTimeZone');
        // expect(instance.deliveryTimeZone).to.be(expectedValueLiteral);
      });

      it('should have the property deliveryWindows (base name: "deliveryWindows")', function() {
        // TODO: update the code to test the property deliveryWindows
        expect(instance).to.have.property('deliveryWindows');
        // expect(instance.deliveryWindows).to.be(expectedValueLiteral);
      });
