  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('ListReturnReasonCodesResult', function() {
      ...
      it('should create an instance of ListReturnReasonCodesResult', function() {
        // TODO: update the code to test ListReturnReasonCodesResult
      ...
      it('should have the property reasonCodeDetails (base name: "reasonCodeDetails")', function() {
        // TODO: update the code to test the property reasonCodeDetails
        expect(instance).to.have.property('reasonCodeDetails');
        // expect(instance.reasonCodeDetails).to.be(expectedValueLiteral);
      });
