...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('IpAddress', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.IpAddress();
      });

      it('should create an instance of IpAddress', function() {
        // TODO: update the code to test IpAddress
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.IpAddress);
      });
