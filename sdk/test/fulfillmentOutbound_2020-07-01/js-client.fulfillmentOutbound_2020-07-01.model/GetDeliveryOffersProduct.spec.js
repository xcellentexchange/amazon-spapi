...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('GetDeliveryOffersProduct', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.GetDeliveryOffersProduct();
      });

      it('should create an instance of GetDeliveryOffersProduct', function() {
        // TODO: update the code to test GetDeliveryOffersProduct
      ...
      it('should have the property productIdentifier (base name: "productIdentifier")', function() {
        // TODO: update the code to test the property productIdentifier
        expect(instance).to.have.property('productIdentifier');
        // expect(instance.productIdentifier).to.be(expectedValueLiteral);
      });
