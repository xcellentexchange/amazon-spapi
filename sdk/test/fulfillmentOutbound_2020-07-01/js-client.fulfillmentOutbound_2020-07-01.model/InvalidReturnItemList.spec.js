...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('InvalidReturnItemList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.InvalidReturnItemList();
      });

      it('should create an instance of InvalidReturnItemList', function() {
        // TODO: update the code to test InvalidReturnItemList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.InvalidReturnItemList);
      });
