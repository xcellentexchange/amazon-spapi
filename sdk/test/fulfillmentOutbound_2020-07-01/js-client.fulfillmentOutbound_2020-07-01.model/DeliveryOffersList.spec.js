...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('DeliveryOffersList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.DeliveryOffersList();
      });

      it('should create an instance of DeliveryOffersList', function() {
        // TODO: update the code to test DeliveryOffersList
        expect(instance).to.be.a(SellingPartnerApisForFulfillmentOutbound.DeliveryOffersList);
      });
