...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('GetFeatureSkuResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.GetFeatureSkuResponse();
      });

      it('should create an instance of GetFeatureSkuResponse', function() {
        // TODO: update the code to test GetFeatureSkuResponse
