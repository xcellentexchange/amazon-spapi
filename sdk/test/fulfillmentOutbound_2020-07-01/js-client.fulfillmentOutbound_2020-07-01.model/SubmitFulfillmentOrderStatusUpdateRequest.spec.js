...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('SubmitFulfillmentOrderStatusUpdateRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.SubmitFulfillmentOrderStatusUpdateRequest();
      });

      it('should create an instance of SubmitFulfillmentOrderStatusUpdateRequest', function() {
        // TODO: update the code to test SubmitFulfillmentOrderStatusUpdateRequest
