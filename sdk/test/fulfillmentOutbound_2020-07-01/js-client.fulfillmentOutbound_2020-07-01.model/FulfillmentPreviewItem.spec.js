  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('FulfillmentPreviewItem', function() {
      ...
      it('should create an instance of FulfillmentPreviewItem', function() {
        // TODO: update the code to test FulfillmentPreviewItem
      ...
      it('should have the property shippingWeightCalculationMethod (base name: "shippingWeightCalculationMethod")', function() {
        // TODO: update the code to test the property shippingWeightCalculationMethod
        expect(instance).to.have.property('shippingWeightCalculationMethod');
        // expect(instance.shippingWeightCalculationMethod).to.be(expectedValueLiteral);
      });
