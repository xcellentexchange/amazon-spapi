...
(function(root, factory) {
  ...
  describe('fulfillmentOutbound_2020-07-01', function() {
    describe('DeliveryInformation', function() {
      beforeEach(function() {
        instance = new SellingPartnerApisForFulfillmentOutbound.DeliveryInformation();
      });

      it('should create an instance of DeliveryInformation', function() {
        // TODO: update the code to test DeliveryInformation
      ...
      it('should have the property deliveryDocumentList (base name: "deliveryDocumentList")', function() {
        // TODO: update the code to test the property deliveryDocumentList
        expect(instance).to.have.property('deliveryDocumentList');
        // expect(instance.deliveryDocumentList).to.be(expectedValueLiteral);
      });
