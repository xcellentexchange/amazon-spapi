...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('StandardHeaderTextListBlock', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.StandardHeaderTextListBlock();
      });

      it('should create an instance of StandardHeaderTextListBlock', function() {
        // TODO: update the code to test StandardHeaderTextListBlock
