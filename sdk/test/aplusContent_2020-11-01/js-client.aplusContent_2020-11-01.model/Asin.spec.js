...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('Asin', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.Asin();
      });

      it('should create an instance of Asin', function() {
        // TODO: update the code to test Asin
        expect(instance).to.be.a(SellingPartnerApiForAContentManagement.Asin);
      });
