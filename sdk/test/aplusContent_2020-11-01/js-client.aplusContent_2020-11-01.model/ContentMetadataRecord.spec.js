...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('ContentMetadataRecord', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.ContentMetadataRecord();
      });

      it('should create an instance of ContentMetadataRecord', function() {
        // TODO: update the code to test ContentMetadataRecord
