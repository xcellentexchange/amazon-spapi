  ...
  describe('aplusContent_2020-11-01', function() {
    describe('TextComponent', function() {
      ...
      it('should create an instance of TextComponent', function() {
        // TODO: update the code to test TextComponent
      ...
      it('should have the property decoratorSet (base name: "decoratorSet")', function() {
        // TODO: update the code to test the property decoratorSet
        expect(instance).to.have.property('decoratorSet');
        // expect(instance.decoratorSet).to.be(expectedValueLiteral);
      });
