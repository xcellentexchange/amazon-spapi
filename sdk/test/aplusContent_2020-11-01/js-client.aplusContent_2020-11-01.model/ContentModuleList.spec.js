...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('ContentModuleList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.ContentModuleList();
      });

      it('should create an instance of ContentModuleList', function() {
        // TODO: update the code to test ContentModuleList
        expect(instance).to.be.a(SellingPartnerApiForAContentManagement.ContentModuleList);
      });
