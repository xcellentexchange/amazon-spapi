...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('StandardCompanyLogoModule', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.StandardCompanyLogoModule();
      });

      it('should create an instance of StandardCompanyLogoModule', function() {
        // TODO: update the code to test StandardCompanyLogoModule
      ...
      it('should have the property companyLogo (base name: "companyLogo")', function() {
        // TODO: update the code to test the property companyLogo
        expect(instance).to.have.property('companyLogo');
        // expect(instance.companyLogo).to.be(expectedValueLiteral);
      });
