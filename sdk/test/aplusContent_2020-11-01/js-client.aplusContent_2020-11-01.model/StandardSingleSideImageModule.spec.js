...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('StandardSingleSideImageModule', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.StandardSingleSideImageModule();
      });

      it('should create an instance of StandardSingleSideImageModule', function() {
        // TODO: update the code to test StandardSingleSideImageModule
      ...
      it('should have the property imagePositionType (base name: "imagePositionType")', function() {
        // TODO: update the code to test the property imagePositionType
        expect(instance).to.have.property('imagePositionType');
        // expect(instance.imagePositionType).to.be(expectedValueLiteral);
      });
