...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('ContentType', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForAContentManagement.ContentType;
      });

      it('should create an instance of ContentType', function() {
        // TODO: update the code to test ContentType
        expect(instance).to.be.a('object');
      });

      it('should have the property EBC', function() {
        expect(instance).to.have.property('EBC');
        expect(instance.EBC).to.be("EBC");
      });

      it('should have the property EMC', function() {
        expect(instance).to.have.property('EMC');
        expect(instance.EMC).to.be("EMC");
      });
