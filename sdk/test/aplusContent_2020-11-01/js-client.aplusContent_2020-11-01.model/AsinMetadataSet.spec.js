...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('AsinMetadataSet', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.AsinMetadataSet();
      });

      it('should create an instance of AsinMetadataSet', function() {
        // TODO: update the code to test AsinMetadataSet
        expect(instance).to.be.a(SellingPartnerApiForAContentManagement.AsinMetadataSet);
      });
