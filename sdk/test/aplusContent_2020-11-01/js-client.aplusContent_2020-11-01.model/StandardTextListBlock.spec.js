...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('StandardTextListBlock', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.StandardTextListBlock();
      });

      it('should create an instance of StandardTextListBlock', function() {
        // TODO: update the code to test StandardTextListBlock
      ...
      it('should have the property textList (base name: "textList")', function() {
        // TODO: update the code to test the property textList
        expect(instance).to.have.property('textList');
        // expect(instance.textList).to.be(expectedValueLiteral);
      });
