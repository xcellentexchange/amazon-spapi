...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('MessageSet', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.MessageSet();
      });

      it('should create an instance of MessageSet', function() {
        // TODO: update the code to test MessageSet
        expect(instance).to.be.a(SellingPartnerApiForAContentManagement.MessageSet);
      });
