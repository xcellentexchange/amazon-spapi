...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('PageToken', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.PageToken();
      });

      it('should create an instance of PageToken', function() {
        // TODO: update the code to test PageToken
        expect(instance).to.be.a(SellingPartnerApiForAContentManagement.PageToken);
      });
