...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('StandardTechSpecsModule', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.StandardTechSpecsModule();
      });

      it('should create an instance of StandardTechSpecsModule', function() {
        // TODO: update the code to test StandardTechSpecsModule
      ...
      it('should have the property specificationList (base name: "specificationList")', function() {
        // TODO: update the code to test the property specificationList
        expect(instance).to.have.property('specificationList');
        // expect(instance.specificationList).to.be(expectedValueLiteral);
      });

      it('should have the property tableCount (base name: "tableCount")', function() {
        // TODO: update the code to test the property tableCount
        expect(instance).to.have.property('tableCount');
        // expect(instance.tableCount).to.be(expectedValueLiteral);
      });
