...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('StandardImageTextOverlayModule', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.StandardImageTextOverlayModule();
      });

      it('should create an instance of StandardImageTextOverlayModule', function() {
        // TODO: update the code to test StandardImageTextOverlayModule
      ...
      it('should have the property overlayColorType (base name: "overlayColorType")', function() {
        // TODO: update the code to test the property overlayColorType
        expect(instance).to.have.property('overlayColorType');
        // expect(instance.overlayColorType).to.be(expectedValueLiteral);
      });
