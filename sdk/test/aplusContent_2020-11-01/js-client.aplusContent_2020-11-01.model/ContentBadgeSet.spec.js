...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('ContentBadgeSet', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.ContentBadgeSet();
      });

      it('should create an instance of ContentBadgeSet', function() {
        // TODO: update the code to test ContentBadgeSet
        expect(instance).to.be.a(SellingPartnerApiForAContentManagement.ContentBadgeSet);
      });
