...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('PublishRecordList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.PublishRecordList();
      });

      it('should create an instance of PublishRecordList', function() {
        // TODO: update the code to test PublishRecordList
        expect(instance).to.be.a(SellingPartnerApiForAContentManagement.PublishRecordList);
      });
