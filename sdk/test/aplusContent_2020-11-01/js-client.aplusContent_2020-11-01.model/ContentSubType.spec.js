...
(function(root, factory) {
  ...
  describe('aplusContent_2020-11-01', function() {
    describe('ContentSubType', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForAContentManagement.ContentSubType();
      });

      it('should create an instance of ContentSubType', function() {
        // TODO: update the code to test ContentSubType
        expect(instance).to.be.a(SellingPartnerApiForAContentManagement.ContentSubType);
      });
