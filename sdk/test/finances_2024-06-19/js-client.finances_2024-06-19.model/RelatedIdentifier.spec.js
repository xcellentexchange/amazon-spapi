  ...
  describe('finances_2024-06-19', function() {
    describe('RelatedIdentifier', function() {
      ...
      it('should create an instance of RelatedIdentifier', function() {
        // TODO: update the code to test RelatedIdentifier
      ...
      it('should have the property relatedIdentifierName (base name: "relatedIdentifierName")', function() {
        // TODO: update the code to test the property relatedIdentifierName
        expect(instance).to.have.property('relatedIdentifierName');
        // expect(instance.relatedIdentifierName).to.be(expectedValueLiteral);
      });

      it('should have the property relatedIdentifierValue (base name: "relatedIdentifierValue")', function() {
        // TODO: update the code to test the property relatedIdentifierValue
        expect(instance).to.have.property('relatedIdentifierValue');
        // expect(instance.relatedIdentifierValue).to.be(expectedValueLiteral);
      });
