  ...
  describe('finances_2024-06-19', function() {
    describe('PaymentsContext', function() {
      ...
      it('should create an instance of PaymentsContext', function() {
        // TODO: update the code to test PaymentsContext
      ...
      it('should have the property paymentReference (base name: "paymentReference")', function() {
        // TODO: update the code to test the property paymentReference
        expect(instance).to.have.property('paymentReference');
        // expect(instance.paymentReference).to.be(expectedValueLiteral);
      });
