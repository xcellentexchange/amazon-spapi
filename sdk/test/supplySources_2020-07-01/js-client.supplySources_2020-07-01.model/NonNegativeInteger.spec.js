...
(function(root, factory) {
  ...
  describe('supplySources_2020-07-01', function() {
    describe('NonNegativeInteger', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForSupplySources.NonNegativeInteger();
      });

      it('should create an instance of NonNegativeInteger', function() {
        // TODO: update the code to test NonNegativeInteger
        expect(instance).to.be.a(SellingPartnerApiForSupplySources.NonNegativeInteger);
      });
