...
(function(root, factory) {
  ...
  describe('supplySources_2020-07-01', function() {
    describe('SupplySourceList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForSupplySources.SupplySourceList();
      });

      it('should create an instance of SupplySourceList', function() {
        // TODO: update the code to test SupplySourceList
        expect(instance).to.be.a(SellingPartnerApiForSupplySources.SupplySourceList);
      });
