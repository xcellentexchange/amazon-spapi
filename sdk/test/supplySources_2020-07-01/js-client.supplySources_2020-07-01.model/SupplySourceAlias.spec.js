...
(function(root, factory) {
  ...
  describe('supplySources_2020-07-01', function() {
    describe('SupplySourceAlias', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForSupplySources.SupplySourceAlias();
      });

      it('should create an instance of SupplySourceAlias', function() {
        // TODO: update the code to test SupplySourceAlias
        expect(instance).to.be.a(SellingPartnerApiForSupplySources.SupplySourceAlias);
      });
