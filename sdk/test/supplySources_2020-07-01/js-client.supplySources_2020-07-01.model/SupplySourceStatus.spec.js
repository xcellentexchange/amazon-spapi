...
(function(root, factory) {
  ...
  describe('supplySources_2020-07-01', function() {
    describe('SupplySourceStatus', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForSupplySources.SupplySourceStatus;
      });

      it('should create an instance of SupplySourceStatus', function() {
        // TODO: update the code to test SupplySourceStatus
