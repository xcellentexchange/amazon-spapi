...
(function(root, factory) {
  ...
  describe('supplySources_2020-07-01', function() {
    describe('ThroughputUnit', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForSupplySources.ThroughputUnit;
      });

      it('should create an instance of ThroughputUnit', function() {
        // TODO: update the code to test ThroughputUnit
