...
(function(root, factory) {
  ...
  describe('supplySources_2020-07-01', function() {
    describe('SupplySourceStatusReadOnly', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForSupplySources.SupplySourceStatusReadOnly;
      });

      it('should create an instance of SupplySourceStatusReadOnly', function() {
        // TODO: update the code to test SupplySourceStatusReadOnly
