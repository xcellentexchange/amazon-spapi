...
(function(root, factory) {
  ...
  describe('supplySources_2020-07-01', function() {
    describe('SupplySourceId', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForSupplySources.SupplySourceId();
      });

      it('should create an instance of SupplySourceId', function() {
        // TODO: update the code to test SupplySourceId
        expect(instance).to.be.a(SellingPartnerApiForSupplySources.SupplySourceId);
      });
