...
(function(root, factory) {
  ...
  describe('supplySources_2020-07-01', function() {
    describe('InStorePickupConfiguration', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForSupplySources.InStorePickupConfiguration();
      });

      it('should create an instance of InStorePickupConfiguration', function() {
        // TODO: update the code to test InStorePickupConfiguration
      ...
      it('should have the property parkingConfiguration (base name: "parkingConfiguration")', function() {
        // TODO: update the code to test the property parkingConfiguration
        expect(instance).to.have.property('parkingConfiguration');
        // expect(instance.parkingConfiguration).to.be(expectedValueLiteral);
      });
