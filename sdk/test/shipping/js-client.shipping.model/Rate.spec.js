  ...
  describe('shipping', function() {
    describe('Rate', function() {
      ...
      it('should have the property expirationTime (base name: "expirationTime")', function() {
        // TODO: update the code to test the property expirationTime
        expect(instance).to.have.property('expirationTime');
        // expect(instance.expirationTime).to.be(expectedValueLiteral);
      });
