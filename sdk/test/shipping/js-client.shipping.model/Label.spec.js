...
(function(root, factory) {
  ...
  describe('shipping', function() {
    describe('Label', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForShipping.Label();
      });

      it('should create an instance of Label', function() {
        // TODO: update the code to test Label
        expect(instance).to.be.a(SellingPartnerApiForShipping.Label);
      });

      it('should have the property labelStream (base name: "labelStream")', function() {
        // TODO: update the code to test the property labelStream
        expect(instance).to.have.property('labelStream');
        // expect(instance.labelStream).to.be(expectedValueLiteral);
      });
