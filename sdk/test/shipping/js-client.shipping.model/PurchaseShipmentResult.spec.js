  ...
  describe('shipping', function() {
    describe('PurchaseShipmentResult', function() {
      ...
      it('should create an instance of PurchaseShipmentResult', function() {
        // TODO: update the code to test PurchaseShipmentResult
      ...
      it('should have the property serviceRate (base name: "serviceRate")', function() {
        // TODO: update the code to test the property serviceRate
        expect(instance).to.have.property('serviceRate');
        // expect(instance.serviceRate).to.be(expectedValueLiteral);
      });
