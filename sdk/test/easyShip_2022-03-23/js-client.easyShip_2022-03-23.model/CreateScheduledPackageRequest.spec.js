...
(function(root, factory) {
  ...
  describe('easyShip_2022-03-23', function() {
    describe('CreateScheduledPackageRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForEasyShip.CreateScheduledPackageRequest();
      });

      it('should create an instance of CreateScheduledPackageRequest', function() {
        // TODO: update the code to test CreateScheduledPackageRequest
      ...
      it('should have the property packageDetails (base name: "packageDetails")', function() {
        // TODO: update the code to test the property packageDetails
        expect(instance).to.have.property('packageDetails');
        // expect(instance.packageDetails).to.be(expectedValueLiteral);
      });
