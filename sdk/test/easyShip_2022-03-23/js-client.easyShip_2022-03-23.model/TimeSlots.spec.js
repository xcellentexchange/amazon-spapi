...
(function(root, factory) {
  ...
  describe('easyShip_2022-03-23', function() {
    describe('TimeSlots', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForEasyShip.TimeSlots();
      });

      it('should create an instance of TimeSlots', function() {
        // TODO: update the code to test TimeSlots
        expect(instance).to.be.a(SellingPartnerApiForEasyShip.TimeSlots);
      });
