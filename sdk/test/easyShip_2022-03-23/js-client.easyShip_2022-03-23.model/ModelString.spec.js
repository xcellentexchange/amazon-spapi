...
(function(root, factory) {
  ...
  describe('easyShip_2022-03-23', function() {
    describe('ModelString', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForEasyShip.ModelString();
      });

      it('should create an instance of ModelString', function() {
        // TODO: update the code to test ModelString
        expect(instance).to.be.a(SellingPartnerApiForEasyShip.ModelString);
      });
