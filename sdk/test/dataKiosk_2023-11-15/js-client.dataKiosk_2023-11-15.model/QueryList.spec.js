...
(function(root, factory) {
  ...
  describe('dataKiosk_2023-11-15', function() {
    describe('QueryList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDataKiosk.QueryList();
      });

      it('should create an instance of QueryList', function() {
        // TODO: update the code to test QueryList
        expect(instance).to.be.a(SellingPartnerApiForDataKiosk.QueryList);
      });
