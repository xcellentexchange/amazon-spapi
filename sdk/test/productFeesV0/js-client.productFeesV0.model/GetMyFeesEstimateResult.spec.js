  ...
  describe('productFeesV0', function() {
    describe('GetMyFeesEstimateResult', function() {
      ...
      it('should create an instance of GetMyFeesEstimateResult', function() {
        // TODO: update the code to test GetMyFeesEstimateResult
      ...
      it('should have the property feesEstimateResult (base name: "FeesEstimateResult")', function() {
        // TODO: update the code to test the property feesEstimateResult
        expect(instance).to.have.property('feesEstimateResult');
        // expect(instance.feesEstimateResult).to.be(expectedValueLiteral);
      });
