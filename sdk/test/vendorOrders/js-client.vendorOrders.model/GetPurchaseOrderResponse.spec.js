...
(function(root, factory) {
  ...
  describe('vendorOrders', function() {
    describe('GetPurchaseOrderResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForRetailProcurementOrders.GetPurchaseOrderResponse();
      });

      it('should create an instance of GetPurchaseOrderResponse', function() {
        // TODO: update the code to test GetPurchaseOrderResponse
