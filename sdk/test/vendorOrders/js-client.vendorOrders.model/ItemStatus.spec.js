...
(function(root, factory) {
  ...
  describe('vendorOrders', function() {
    describe('ItemStatus', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForRetailProcurementOrders.ItemStatus();
      });

      it('should create an instance of ItemStatus', function() {
        // TODO: update the code to test ItemStatus
        expect(instance).to.be.a(SellingPartnerApiForRetailProcurementOrders.ItemStatus);
      });
