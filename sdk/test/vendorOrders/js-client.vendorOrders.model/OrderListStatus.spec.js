  ...
  describe('vendorOrders', function() {
    describe('OrderListStatus', function() {
      ...
      it('should create an instance of OrderListStatus', function() {
        // TODO: update the code to test OrderListStatus
      ...
      it('should have the property ordersStatus (base name: "ordersStatus")', function() {
        // TODO: update the code to test the property ordersStatus
        expect(instance).to.have.property('ordersStatus');
        // expect(instance.ordersStatus).to.be(expectedValueLiteral);
      });
