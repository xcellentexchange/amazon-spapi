...
(function(root, factory) {
  ...
  describe('shipmentInvoicingV0', function() {
    describe('ShipmentItems', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForShipmentInvoicing.ShipmentItems();
      });

      it('should create an instance of ShipmentItems', function() {
        // TODO: update the code to test ShipmentItems
        expect(instance).to.be.a(SellingPartnerApiForShipmentInvoicing.ShipmentItems);
      });
