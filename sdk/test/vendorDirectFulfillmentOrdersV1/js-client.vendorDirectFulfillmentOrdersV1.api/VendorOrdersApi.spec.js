      ...
      describe('getOrder', function() {
        it('should call getOrder successfully', function(done) {
          ...
          instance.getOrder(purchaseOrderNumber).then(function(data) {
            ...
            expect(data).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.GetOrderResponse);
            expect(data.payload).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Order);
                  expect(data.payload.purchaseOrderNumber).to.be.a('string');
              // expect(data.payload.purchaseOrderNumber).to.be("");
              expect(data.payload.orderDetails).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.OrderDetails);
                    expect(data.payload.orderDetails.customerOrderNumber).to.be.a('string');
                // expect(data.payload.orderDetails.customerOrderNumber).to.be("");
                expect(data.payload.orderDetails.orderDate).to.be.a(Date);
                // expect(data.payload.orderDetails.orderDate).to.be(new Date());
                expect(data.payload.orderDetails.orderStatus).to.be.a('string');
                // expect(data.payload.orderDetails.orderStatus).to.be("NEW");
                expect(data.payload.orderDetails.shipmentDetails).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.ShipmentDetails);
                      expect(data.payload.orderDetails.shipmentDetails.isPriorityShipment).to.be.a('boolean');
                  // expect(data.payload.orderDetails.shipmentDetails.isPriorityShipment).to.be(false);
                  expect(data.payload.orderDetails.shipmentDetails.isScheduledDeliveryShipment).to.be.a('boolean');
                  // expect(data.payload.orderDetails.shipmentDetails.isScheduledDeliveryShipment).to.be(false);
                  expect(data.payload.orderDetails.shipmentDetails.isPslipRequired).to.be.a('boolean');
                  // expect(data.payload.orderDetails.shipmentDetails.isPslipRequired).to.be(false);
                  expect(data.payload.orderDetails.shipmentDetails.isGift).to.be.a('boolean');
                  // expect(data.payload.orderDetails.shipmentDetails.isGift).to.be(false);
                  expect(data.payload.orderDetails.shipmentDetails.shipMethod).to.be.a('string');
                  // expect(data.payload.orderDetails.shipmentDetails.shipMethod).to.be("");
                  expect(data.payload.orderDetails.shipmentDetails.shipmentDates).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.ShipmentDates);
                        expect(data.payload.orderDetails.shipmentDetails.shipmentDates.requiredShipDate).to.be.a(Date);
                    // expect(data.payload.orderDetails.shipmentDetails.shipmentDates.requiredShipDate).to.be(new Date());
                    expect(data.payload.orderDetails.shipmentDetails.shipmentDates.promisedDeliveryDate).to.be.a(Date);
                    // expect(data.payload.orderDetails.shipmentDetails.shipmentDates.promisedDeliveryDate).to.be(new Date());
                  expect(data.payload.orderDetails.shipmentDetails.messageToCustomer).to.be.a('string');
                  // expect(data.payload.orderDetails.shipmentDetails.messageToCustomer).to.be("");
                expect(data.payload.orderDetails.taxTotal).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.OrderDetailsTaxTotal);
                      expect(data.payload.orderDetails.taxTotal.taxLineItem).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.TaxLineItem);
          
                expect(data.payload.orderDetails.sellingParty).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.PartyIdentification);
                  ...
                  expect(data.payload.orderDetails.sellingParty.address).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Address);
                    ...
                    expect(data.payload.orderDetails.sellingParty.address.attention).to.be.a('string');
                    // expect(data.payload.orderDetails.sellingParty.address.attention).to.be("");
                  ...
                  expect(data.payload.orderDetails.sellingParty.taxInfo).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.TaxRegistrationDetails);
                    ...
                    expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Address);
                          expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.name).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.name).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.attention).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.attention).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.addressLine1).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.addressLine1).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.addressLine2).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.addressLine2).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.addressLine3).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.addressLine3).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.city).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.city).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.county).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.county).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.district).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.district).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.stateOrRegion).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.stateOrRegion).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.postalCode).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.postalCode).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.countryCode).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.countryCode).to.be("");
                      expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.phone).to.be.a('string');
                      // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationAddress.phone).to.be("");
                    expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationMessages).to.be.a('string');
                    // expect(data.payload.orderDetails.sellingParty.taxInfo.taxRegistrationMessages).to.be("");
                expect(data.payload.orderDetails.shipFromParty).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.PartyIdentification);
                      expect(data.payload.orderDetails.shipFromParty.partyId).to.be.a('string');
                  // expect(data.payload.orderDetails.shipFromParty.partyId).to.be("");
                  expect(data.payload.orderDetails.shipFromParty.address).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Address);
                        expect(data.payload.orderDetails.shipFromParty.address.name).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.name).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.attention).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.attention).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.addressLine1).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.addressLine1).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.addressLine2).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.addressLine2).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.addressLine3).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.addressLine3).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.city).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.city).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.county).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.county).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.district).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.district).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.stateOrRegion).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.stateOrRegion).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.postalCode).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.postalCode).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.countryCode).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.countryCode).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.address.phone).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.address.phone).to.be("");
                  expect(data.payload.orderDetails.shipFromParty.taxInfo).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.TaxRegistrationDetails);
                        expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationType).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationType).to.be("VAT");
                    expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationNumber).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationNumber).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Address);
                          expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.name).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.name).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.attention).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.attention).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.addressLine1).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.addressLine1).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.addressLine2).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.addressLine2).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.addressLine3).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.addressLine3).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.city).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.city).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.county).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.county).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.district).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.district).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.stateOrRegion).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.stateOrRegion).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.postalCode).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.postalCode).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.countryCode).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.countryCode).to.be("");
                      expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.phone).to.be.a('string');
                      // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationAddress.phone).to.be("");
                    expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationMessages).to.be.a('string');
                    // expect(data.payload.orderDetails.shipFromParty.taxInfo.taxRegistrationMessages).to.be("");
                expect(data.payload.orderDetails.shipToParty).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Address);
                      expect(data.payload.orderDetails.shipToParty.name).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.name).to.be("");
                  expect(data.payload.orderDetails.shipToParty.attention).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.attention).to.be("");
                  expect(data.payload.orderDetails.shipToParty.addressLine1).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.addressLine1).to.be("");
                  expect(data.payload.orderDetails.shipToParty.addressLine2).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.addressLine2).to.be("");
                  expect(data.payload.orderDetails.shipToParty.addressLine3).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.addressLine3).to.be("");
                  expect(data.payload.orderDetails.shipToParty.city).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.city).to.be("");
                  expect(data.payload.orderDetails.shipToParty.county).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.county).to.be("");
                  expect(data.payload.orderDetails.shipToParty.district).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.district).to.be("");
                  expect(data.payload.orderDetails.shipToParty.stateOrRegion).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.stateOrRegion).to.be("");
                  expect(data.payload.orderDetails.shipToParty.postalCode).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.postalCode).to.be("");
                  expect(data.payload.orderDetails.shipToParty.countryCode).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.countryCode).to.be("");
                  expect(data.payload.orderDetails.shipToParty.phone).to.be.a('string');
                  // expect(data.payload.orderDetails.shipToParty.phone).to.be("");
                expect(data.payload.orderDetails.billToParty).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.PartyIdentification);
                  ...
                  expect(data.payload.orderDetails.billToParty.address).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Address);
                    ...
                    expect(data.payload.orderDetails.billToParty.address.attention).to.be.a('string');
                    // expect(data.payload.orderDetails.billToParty.address.attention).to.be("");
                  ...
                  expect(data.payload.orderDetails.billToParty.taxInfo).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.TaxRegistrationDetails);
                    ...
                    expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Address);
                          expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.name).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.name).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.attention).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.attention).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.addressLine1).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.addressLine1).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.addressLine2).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.addressLine2).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.addressLine3).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.addressLine3).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.city).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.city).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.county).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.county).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.district).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.district).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.stateOrRegion).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.stateOrRegion).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.postalCode).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.postalCode).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.countryCode).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.countryCode).to.be("");
                      expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.phone).to.be.a('string');
                      // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationAddress.phone).to.be("");
                    expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationMessages).to.be.a('string');
                    // expect(data.payload.orderDetails.billToParty.taxInfo.taxRegistrationMessages).to.be("");
                {
                  ...
                  for (let p in dataCtr) {
                    ...
                    expect(data.taxDetails).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.OrderItemTaxDetails);
            ...
            expect(data.errors).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.ErrorList);
      ...
      describe('getOrders', function() {
        it('should call getOrders successfully', function(done) {
          ...
          instance.getOrders(createdAfter, createdBefore, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.GetOrdersResponse);
            expect(data.payload).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.OrderList);
                  expect(data.payload.pagination).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.Pagination);
                ...
                // expect(data.payload.pagination.nextToken).to.be("");
              {
                ...
                for (let p in dataCtr) {
                  ...
                  expect(data.orderDetails).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.OrderDetails);
                    ...
                    expect(data.orderDetails.taxTotal).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.OrderDetailsTaxTotal);
      ...
      describe('submitAcknowledgement', function() {
        it('should call submitAcknowledgement successfully', function(done) {
          ...
          instance.submitAcknowledgement(body).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.SubmitAcknowledgementResponse);
            expect(data.payload).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.TransactionId);
