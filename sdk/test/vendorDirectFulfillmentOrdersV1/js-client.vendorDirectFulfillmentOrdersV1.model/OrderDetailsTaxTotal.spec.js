...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentOrdersV1', function() {
    describe('OrderDetailsTaxTotal', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentOrders.OrderDetailsTaxTotal();
      });

      it('should create an instance of OrderDetailsTaxTotal', function() {
        // TODO: update the code to test OrderDetailsTaxTotal
        expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.OrderDetailsTaxTotal);
      });
