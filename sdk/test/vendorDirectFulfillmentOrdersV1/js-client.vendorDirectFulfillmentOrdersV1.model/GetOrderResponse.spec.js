...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentOrdersV1', function() {
    describe('GetOrderResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentOrders.GetOrderResponse();
      });

      it('should create an instance of GetOrderResponse', function() {
        // TODO: update the code to test GetOrderResponse
        expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentOrders.GetOrderResponse);
      });
