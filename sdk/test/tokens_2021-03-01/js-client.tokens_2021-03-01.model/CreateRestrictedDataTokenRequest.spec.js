...
(function(root, factory) {
  ...
  describe('tokens_2021-03-01', function() {
    describe('CreateRestrictedDataTokenRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForTokens_.CreateRestrictedDataTokenRequest();
      });

      it('should create an instance of CreateRestrictedDataTokenRequest', function() {
        // TODO: update the code to test CreateRestrictedDataTokenRequest
        expect(instance).to.be.a(SellingPartnerApiForTokens_.CreateRestrictedDataTokenRequest);
      });

      it('should have the property targetApplication (base name: "targetApplication")', function() {
        // TODO: update the code to test the property targetApplication
        expect(instance).to.have.property('targetApplication');
        // expect(instance.targetApplication).to.be(expectedValueLiteral);
      });

      it('should have the property restrictedResources (base name: "restrictedResources")', function() {
        // TODO: update the code to test the property restrictedResources
        expect(instance).to.have.property('restrictedResources');
        // expect(instance.restrictedResources).to.be(expectedValueLiteral);
      });
