...
(function(root, factory) {
  ...
  describe('listingsItems_2020-09-01', function() {
    describe('ListingsItemPatchRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForListingsItems.ListingsItemPatchRequest();
      });

      it('should create an instance of ListingsItemPatchRequest', function() {
        // TODO: update the code to test ListingsItemPatchRequest
