...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentSandboxData_2021-10-28', function() {
    describe('TransactionStatus', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForVendorDirectFulfillmentSandboxTestData.TransactionStatus();
      });

      it('should create an instance of TransactionStatus', function() {
        // TODO: update the code to test TransactionStatus
        expect(instance).to.be.a(SellingPartnerApiForVendorDirectFulfillmentSandboxTestData.TransactionStatus);
      });
