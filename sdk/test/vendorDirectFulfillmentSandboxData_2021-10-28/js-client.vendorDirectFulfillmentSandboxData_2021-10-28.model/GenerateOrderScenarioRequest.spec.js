...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentSandboxData_2021-10-28', function() {
    describe('GenerateOrderScenarioRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForVendorDirectFulfillmentSandboxTestData.GenerateOrderScenarioRequest();
      });

      it('should create an instance of GenerateOrderScenarioRequest', function() {
        // TODO: update the code to test GenerateOrderScenarioRequest
        expect(instance).to.be.a(SellingPartnerApiForVendorDirectFulfillmentSandboxTestData.GenerateOrderScenarioRequest);
      });
