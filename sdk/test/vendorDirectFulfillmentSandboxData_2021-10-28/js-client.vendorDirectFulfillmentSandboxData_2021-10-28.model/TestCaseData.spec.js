...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentSandboxData_2021-10-28', function() {
    describe('TestCaseData', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForVendorDirectFulfillmentSandboxTestData.TestCaseData();
      });

      it('should create an instance of TestCaseData', function() {
        // TODO: update the code to test TestCaseData
        expect(instance).to.be.a(SellingPartnerApiForVendorDirectFulfillmentSandboxTestData.TestCaseData);
      });
