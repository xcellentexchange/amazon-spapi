...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentSandboxData_2021-10-28', function() {
    describe('PartyIdentification', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForVendorDirectFulfillmentSandboxTestData.PartyIdentification();
      });

      it('should create an instance of PartyIdentification', function() {
        // TODO: update the code to test PartyIdentification
        expect(instance).to.be.a(SellingPartnerApiForVendorDirectFulfillmentSandboxTestData.PartyIdentification);
      });
