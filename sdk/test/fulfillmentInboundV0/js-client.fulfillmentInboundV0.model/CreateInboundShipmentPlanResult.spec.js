  ...
  describe('fulfillmentInboundV0', function() {
    describe('CreateInboundShipmentPlanResult', function() {
      ...
      it('should create an instance of CreateInboundShipmentPlanResult', function() {
        // TODO: update the code to test CreateInboundShipmentPlanResult
      ...
      it('should have the property inboundShipmentPlans (base name: "InboundShipmentPlans")', function() {
        // TODO: update the code to test the property inboundShipmentPlans
        expect(instance).to.have.property('inboundShipmentPlans');
        // expect(instance.inboundShipmentPlans).to.be(expectedValueLiteral);
      });
