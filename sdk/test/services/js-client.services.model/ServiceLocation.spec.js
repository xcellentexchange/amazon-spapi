  ...
  describe('services', function() {
    describe('ServiceLocation', function() {
      ...
      it('should create an instance of ServiceLocation', function() {
        // TODO: update the code to test ServiceLocation
      ...
      it('should have the property serviceLocationType (base name: "serviceLocationType")', function() {
        // TODO: update the code to test the property serviceLocationType
        expect(instance).to.have.property('serviceLocationType');
        // expect(instance.serviceLocationType).to.be(expectedValueLiteral);
      });
