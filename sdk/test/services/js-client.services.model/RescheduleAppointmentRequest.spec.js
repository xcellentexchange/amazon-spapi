  ...
  describe('services', function() {
    describe('RescheduleAppointmentRequest', function() {
      ...
      it('should create an instance of RescheduleAppointmentRequest', function() {
        // TODO: update the code to test RescheduleAppointmentRequest
      ...
      it('should have the property rescheduleReasonCode (base name: "rescheduleReasonCode")', function() {
        // TODO: update the code to test the property rescheduleReasonCode
        expect(instance).to.have.property('rescheduleReasonCode');
        // expect(instance.rescheduleReasonCode).to.be(expectedValueLiteral);
      });
