  ...
  describe('services', function() {
    describe('ServiceUploadDocument', function() {
      ...
      it('should create an instance of ServiceUploadDocument', function() {
        // TODO: update the code to test ServiceUploadDocument
      ...
      it('should have the property contentMD5 (base name: "contentMD5")', function() {
        // TODO: update the code to test the property contentMD5
        expect(instance).to.have.property('contentMD5');
        // expect(instance.contentMD5).to.be(expectedValueLiteral);
      });
