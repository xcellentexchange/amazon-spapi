  ...
  describe('services', function() {
    describe('SetAppointmentFulfillmentDataRequest', function() {
      ...
      it('should create an instance of SetAppointmentFulfillmentDataRequest', function() {
        // TODO: update the code to test SetAppointmentFulfillmentDataRequest
      ...
      it('should have the property fulfillmentTime (base name: "fulfillmentTime")', function() {
        // TODO: update the code to test the property fulfillmentTime
        expect(instance).to.have.property('fulfillmentTime');
        // expect(instance.fulfillmentTime).to.be(expectedValueLiteral);
      });

      it('should have the property appointmentResources (base name: "appointmentResources")', function() {
        // TODO: update the code to test the property appointmentResources
        expect(instance).to.have.property('appointmentResources');
        // expect(instance.appointmentResources).to.be(expectedValueLiteral);
      });

      it('should have the property fulfillmentDocuments (base name: "fulfillmentDocuments")', function() {
        // TODO: update the code to test the property fulfillmentDocuments
        expect(instance).to.have.property('fulfillmentDocuments');
        // expect(instance.fulfillmentDocuments).to.be(expectedValueLiteral);
      });
