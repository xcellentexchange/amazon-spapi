...
(function(root, factory) {
  ...
  describe('services', function() {
    describe('AssignAppointmentResourcesResponsePayload', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForServices.AssignAppointmentResourcesResponsePayload();
      });

      it('should create an instance of AssignAppointmentResourcesResponsePayload', function() {
        // TODO: update the code to test AssignAppointmentResourcesResponsePayload
