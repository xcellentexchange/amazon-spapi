...
(function(root, factory) {
  ...
  describe('services', function() {
    describe('UpdateScheduleResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForServices.UpdateScheduleResponse();
      });

      it('should create an instance of UpdateScheduleResponse', function() {
        // TODO: update the code to test UpdateScheduleResponse
