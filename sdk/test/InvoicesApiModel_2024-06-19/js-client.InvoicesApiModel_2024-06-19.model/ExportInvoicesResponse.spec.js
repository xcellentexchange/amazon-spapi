...
(function(root, factory) {
  ...
  describe('InvoicesApiModel_2024-06-19', function() {
    describe('ExportInvoicesResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForInvoices.ExportInvoicesResponse();
      });

      it('should create an instance of ExportInvoicesResponse', function() {
        // TODO: update the code to test ExportInvoicesResponse
