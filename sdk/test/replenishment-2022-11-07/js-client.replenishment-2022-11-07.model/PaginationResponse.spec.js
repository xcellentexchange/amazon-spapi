  ...
  describe('replenishment-2022-11-07', function() {
    describe('PaginationResponse', function() {
      ...
      it('should create an instance of PaginationResponse', function() {
        // TODO: update the code to test PaginationResponse
      ...
      it('should have the property totalResults (base name: "totalResults")', function() {
        // TODO: update the code to test the property totalResults
        expect(instance).to.have.property('totalResults');
        // expect(instance.totalResults).to.be(expectedValueLiteral);
      });
