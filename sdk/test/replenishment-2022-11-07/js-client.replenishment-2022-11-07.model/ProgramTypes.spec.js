...
(function(root, factory) {
  ...
  describe('replenishment-2022-11-07', function() {
    describe('ProgramTypes', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForReplenishment.ProgramTypes();
      });

      it('should create an instance of ProgramTypes', function() {
        // TODO: update the code to test ProgramTypes
        expect(instance).to.be.a(SellingPartnerApiForReplenishment.ProgramTypes);
      });
