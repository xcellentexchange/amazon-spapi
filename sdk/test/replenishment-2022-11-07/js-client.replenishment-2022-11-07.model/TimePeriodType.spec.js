...
(function(root, factory) {
  ...
  describe('replenishment-2022-11-07', function() {
    describe('TimePeriodType', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForReplenishment.TimePeriodType;
      });

      it('should create an instance of TimePeriodType', function() {
        // TODO: update the code to test TimePeriodType
        expect(instance).to.be.a('object');
      });

      it('should have the property PERFORMANCE', function() {
        expect(instance).to.have.property('PERFORMANCE');
        expect(instance.PERFORMANCE).to.be("PERFORMANCE");
      });

      it('should have the property FORECAST', function() {
        expect(instance).to.have.property('FORECAST');
        expect(instance.FORECAST).to.be("FORECAST");
      });
