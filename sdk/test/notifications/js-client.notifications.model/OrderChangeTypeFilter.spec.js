...
(function(root, factory) {
  ...
  describe('notifications', function() {
    describe('OrderChangeTypeFilter', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForNotifications.OrderChangeTypeFilter();
      });

      it('should create an instance of OrderChangeTypeFilter', function() {
        // TODO: update the code to test OrderChangeTypeFilter
      ...
      it('should have the property orderChangeTypes (base name: "orderChangeTypes")', function() {
        // TODO: update the code to test the property orderChangeTypes
        expect(instance).to.have.property('orderChangeTypes');
        // expect(instance.orderChangeTypes).to.be(expectedValueLiteral);
      });
