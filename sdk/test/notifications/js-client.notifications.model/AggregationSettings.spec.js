...
(function(root, factory) {
  ...
  describe('notifications', function() {
    describe('AggregationSettings', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForNotifications.AggregationSettings();
      });

      it('should create an instance of AggregationSettings', function() {
        // TODO: update the code to test AggregationSettings
      ...
      it('should have the property aggregationTimePeriod (base name: "aggregationTimePeriod")', function() {
        // TODO: update the code to test the property aggregationTimePeriod
        expect(instance).to.have.property('aggregationTimePeriod');
        // expect(instance.aggregationTimePeriod).to.be(expectedValueLiteral);
      });
