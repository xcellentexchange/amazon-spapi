  ...
  describe('notifications', function() {
    describe('EventFilter', function() {
      ...
      it('should create an instance of EventFilter', function() {
        // TODO: update the code to test EventFilter
      ...
      it('should have the property eventFilterType (base name: "eventFilterType")', function() {
        // TODO: update the code to test the property eventFilterType
        expect(instance).to.have.property('eventFilterType');
        // expect(instance.eventFilterType).to.be(expectedValueLiteral);
      });
