...
(function(root, factory) {
  ...
  describe('notifications', function() {
    describe('ProcessingDirective', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForNotifications.ProcessingDirective();
      });

      it('should create an instance of ProcessingDirective', function() {
        // TODO: update the code to test ProcessingDirective
      ...
      it('should have the property eventFilter (base name: "eventFilter")', function() {
        // TODO: update the code to test the property eventFilter
        expect(instance).to.have.property('eventFilter');
        // expect(instance.eventFilter).to.be(expectedValueLiteral);
      });
