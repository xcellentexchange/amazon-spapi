...
(function(root, factory) {
  ...
  describe('fbaInventory', function() {
    describe('InventoryItems', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForFbaInventory.InventoryItems();
      });

      it('should create an instance of InventoryItems', function() {
        // TODO: update the code to test InventoryItems
        expect(instance).to.be.a(SellingPartnerApiForFbaInventory.InventoryItems);
      });
