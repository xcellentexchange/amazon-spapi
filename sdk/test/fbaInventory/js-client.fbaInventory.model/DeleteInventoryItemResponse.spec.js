...
(function(root, factory) {
  ...
  describe('fbaInventory', function() {
    describe('DeleteInventoryItemResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForFbaInventory.DeleteInventoryItemResponse();
      });

      it('should create an instance of DeleteInventoryItemResponse', function() {
        // TODO: update the code to test DeleteInventoryItemResponse
