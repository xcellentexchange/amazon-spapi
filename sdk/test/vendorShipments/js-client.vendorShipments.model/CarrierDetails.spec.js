  ...
  describe('vendorShipments', function() {
    describe('CarrierDetails', function() {
      ...
      it('should create an instance of CarrierDetails', function() {
        // TODO: update the code to test CarrierDetails
      ...
      it('should have the property shipmentReferenceNumber (base name: "shipmentReferenceNumber")', function() {
        // TODO: update the code to test the property shipmentReferenceNumber
        expect(instance).to.have.property('shipmentReferenceNumber');
        // expect(instance.shipmentReferenceNumber).to.be(expectedValueLiteral);
      });
