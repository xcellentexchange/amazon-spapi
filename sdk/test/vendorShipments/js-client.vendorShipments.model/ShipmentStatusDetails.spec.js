...
(function(root, factory) {
  ...
  describe('vendorShipments', function() {
    describe('ShipmentStatusDetails', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForRetailProcurementShipments.ShipmentStatusDetails();
      });

      it('should create an instance of ShipmentStatusDetails', function() {
        // TODO: update the code to test ShipmentStatusDetails
      ...
      it('should have the property shipmentStatusDate (base name: "shipmentStatusDate")', function() {
        // TODO: update the code to test the property shipmentStatusDate
        expect(instance).to.have.property('shipmentStatusDate');
        // expect(instance.shipmentStatusDate).to.be(expectedValueLiteral);
      });
