...
(function(root, factory) {
  ...
  describe('messaging', function() {
    describe('CreateConfirmCustomizationDetailsResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMessaging.CreateConfirmCustomizationDetailsResponse();
      });

      it('should create an instance of CreateConfirmCustomizationDetailsResponse', function() {
        // TODO: update the code to test CreateConfirmCustomizationDetailsResponse
