...
(function(root, factory) {
  ...
  describe('messaging', function() {
    describe('CreateLegalDisclosureRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMessaging.CreateLegalDisclosureRequest();
      });

      it('should create an instance of CreateLegalDisclosureRequest', function() {
        // TODO: update the code to test CreateLegalDisclosureRequest
