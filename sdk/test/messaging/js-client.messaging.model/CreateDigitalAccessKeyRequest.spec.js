...
(function(root, factory) {
  ...
  describe('messaging', function() {
    describe('CreateDigitalAccessKeyRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMessaging.CreateDigitalAccessKeyRequest();
      });

      it('should create an instance of CreateDigitalAccessKeyRequest', function() {
        // TODO: update the code to test CreateDigitalAccessKeyRequest
