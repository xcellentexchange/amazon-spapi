...
(function(root, factory) {
  ...
  describe('messaging', function() {
    describe('GetMessagingActionResponseLinks', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMessaging.GetMessagingActionResponseLinks();
      });

      it('should create an instance of GetMessagingActionResponseLinks', function() {
        // TODO: update the code to test GetMessagingActionResponseLinks
