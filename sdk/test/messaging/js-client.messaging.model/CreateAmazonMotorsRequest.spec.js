...
(function(root, factory) {
  ...
  describe('messaging', function() {
    describe('CreateAmazonMotorsRequest', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForMessaging.CreateAmazonMotorsRequest();
      });

      it('should create an instance of CreateAmazonMotorsRequest', function() {
        // TODO: update the code to test CreateAmazonMotorsRequest
