        ...
        it('should call getCatalogItem successfully', function(done) {
          ...
          instance.getCatalogItem(asin, marketplaceIds, opts).then(function(data) {
            ...
            expect(data.asin).to.be.a(SellingPartnerApiForCatalogItems.ItemAsin);
                ...
                expect(data.classifications).to.be.a(SellingPartnerApiForCatalogItems.ItemBrowseClassifications);
                expect(data.dimensions).to.be.a(SellingPartnerApiForCatalogItems.ItemDimensions);
                ...
                expect(data.relationships).to.be.a(SellingPartnerApiForCatalogItems.ItemRelationships);
