...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('ListTransportationOptionsResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.ListTransportationOptionsResponse();
      });

      it('should create an instance of ListTransportationOptionsResponse', function() {
        // TODO: update the code to test ListTransportationOptionsResponse
      ...
      it('should have the property transportationOptions (base name: "transportationOptions")', function() {
        // TODO: update the code to test the property transportationOptions
        expect(instance).to.have.property('transportationOptions');
        // expect(instance.transportationOptions).to.be(expectedValueLiteral);
      });
