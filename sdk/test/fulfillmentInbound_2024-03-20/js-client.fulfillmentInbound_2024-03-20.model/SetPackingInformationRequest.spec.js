...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('SetPackingInformationRequest', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.SetPackingInformationRequest();
      });

      it('should create an instance of SetPackingInformationRequest', function() {
        // TODO: update the code to test SetPackingInformationRequest
      ...
      it('should have the property packageGroupings (base name: "packageGroupings")', function() {
        // TODO: update the code to test the property packageGroupings
        expect(instance).to.have.property('packageGroupings');
        // expect(instance.packageGroupings).to.be(expectedValueLiteral);
      });
