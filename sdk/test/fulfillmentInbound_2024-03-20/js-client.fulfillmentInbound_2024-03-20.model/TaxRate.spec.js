  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('TaxRate', function() {
      ...
      it('should have the property cessRate (base name: "cessRate")', function() {
        // TODO: update the code to test the property cessRate
        expect(instance).to.have.property('cessRate');
        // expect(instance.cessRate).to.be(expectedValueLiteral);
      });

      it('should have the property gstRate (base name: "gstRate")', function() {
        // TODO: update the code to test the property gstRate
        expect(instance).to.have.property('gstRate');
        // expect(instance.gstRate).to.be(expectedValueLiteral);
      });
