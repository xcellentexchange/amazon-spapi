...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('SpdTrackingDetailInput', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.SpdTrackingDetailInput();
      });

      it('should create an instance of SpdTrackingDetailInput', function() {
        // TODO: update the code to test SpdTrackingDetailInput
      ...
      it('should have the property spdTrackingItems (base name: "spdTrackingItems")', function() {
        // TODO: update the code to test the property spdTrackingItems
        expect(instance).to.have.property('spdTrackingItems');
        // expect(instance.spdTrackingItems).to.be(expectedValueLiteral);
      });
