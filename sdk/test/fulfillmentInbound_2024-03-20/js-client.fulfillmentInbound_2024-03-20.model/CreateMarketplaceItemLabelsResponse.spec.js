...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('CreateMarketplaceItemLabelsResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.CreateMarketplaceItemLabelsResponse();
      });

      it('should create an instance of CreateMarketplaceItemLabelsResponse', function() {
        // TODO: update the code to test CreateMarketplaceItemLabelsResponse
      ...
      it('should have the property documentDownloads (base name: "documentDownloads")', function() {
        // TODO: update the code to test the property documentDownloads
        expect(instance).to.have.property('documentDownloads');
        // expect(instance.documentDownloads).to.be(expectedValueLiteral);
      });
