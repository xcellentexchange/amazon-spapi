...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('ListInboundPlansResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.ListInboundPlansResponse();
      });

      it('should create an instance of ListInboundPlansResponse', function() {
        // TODO: update the code to test ListInboundPlansResponse
      ...
      it('should have the property inboundPlans (base name: "inboundPlans")', function() {
        // TODO: update the code to test the property inboundPlans
        expect(instance).to.have.property('inboundPlans');
        // expect(instance.inboundPlans).to.be(expectedValueLiteral);
      });
