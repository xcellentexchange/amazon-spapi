...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('ConfirmTransportationOptionsRequest', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.ConfirmTransportationOptionsRequest();
      });

      it('should create an instance of ConfirmTransportationOptionsRequest', function() {
        // TODO: update the code to test ConfirmTransportationOptionsRequest
      ...
      it('should have the property transportationSelections (base name: "transportationSelections")', function() {
        // TODO: update the code to test the property transportationSelections
        expect(instance).to.have.property('transportationSelections');
        // expect(instance.transportationSelections).to.be(expectedValueLiteral);
      });
