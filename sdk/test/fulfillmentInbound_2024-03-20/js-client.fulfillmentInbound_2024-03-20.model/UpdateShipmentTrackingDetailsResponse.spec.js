...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('UpdateShipmentTrackingDetailsResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.UpdateShipmentTrackingDetailsResponse();
      });

      it('should create an instance of UpdateShipmentTrackingDetailsResponse', function() {
        // TODO: update the code to test UpdateShipmentTrackingDetailsResponse
