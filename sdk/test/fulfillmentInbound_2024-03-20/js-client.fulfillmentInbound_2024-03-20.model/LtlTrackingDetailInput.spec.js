...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('LtlTrackingDetailInput', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.LtlTrackingDetailInput();
      });

      it('should create an instance of LtlTrackingDetailInput', function() {
        // TODO: update the code to test LtlTrackingDetailInput
