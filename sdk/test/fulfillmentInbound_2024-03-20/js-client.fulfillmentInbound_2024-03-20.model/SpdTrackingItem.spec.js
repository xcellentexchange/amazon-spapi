...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('SpdTrackingItem', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.SpdTrackingItem();
      });

      it('should create an instance of SpdTrackingItem', function() {
        // TODO: update the code to test SpdTrackingItem
      ...
      it('should have the property trackingNumberValidationStatus (base name: "trackingNumberValidationStatus")', function() {
        // TODO: update the code to test the property trackingNumberValidationStatus
        expect(instance).to.have.property('trackingNumberValidationStatus');
        // expect(instance.trackingNumberValidationStatus).to.be(expectedValueLiteral);
      });
