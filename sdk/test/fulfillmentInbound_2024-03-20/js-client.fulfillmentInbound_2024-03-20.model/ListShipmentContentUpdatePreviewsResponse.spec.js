...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('ListShipmentContentUpdatePreviewsResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.ListShipmentContentUpdatePreviewsResponse();
      });

      it('should create an instance of ListShipmentContentUpdatePreviewsResponse', function() {
        // TODO: update the code to test ListShipmentContentUpdatePreviewsResponse
      ...
      it('should have the property contentUpdatePreviews (base name: "contentUpdatePreviews")', function() {
        // TODO: update the code to test the property contentUpdatePreviews
        expect(instance).to.have.property('contentUpdatePreviews');
        // expect(instance.contentUpdatePreviews).to.be(expectedValueLiteral);
      });
