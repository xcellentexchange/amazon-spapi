...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('ListPrepDetailsResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.ListPrepDetailsResponse();
      });

      it('should create an instance of ListPrepDetailsResponse', function() {
        // TODO: update the code to test ListPrepDetailsResponse
      ...
      it('should have the property mskuPrepDetails (base name: "mskuPrepDetails")', function() {
        // TODO: update the code to test the property mskuPrepDetails
        expect(instance).to.have.property('mskuPrepDetails');
        // expect(instance.mskuPrepDetails).to.be(expectedValueLiteral);
      });
