...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('GetDeliveryChallanDocumentResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.GetDeliveryChallanDocumentResponse();
      });

      it('should create an instance of GetDeliveryChallanDocumentResponse', function() {
        // TODO: update the code to test GetDeliveryChallanDocumentResponse
      ...
      it('should have the property documentDownload (base name: "documentDownload")', function() {
        // TODO: update the code to test the property documentDownload
        expect(instance).to.have.property('documentDownload');
        // expect(instance.documentDownload).to.be(expectedValueLiteral);
      });
