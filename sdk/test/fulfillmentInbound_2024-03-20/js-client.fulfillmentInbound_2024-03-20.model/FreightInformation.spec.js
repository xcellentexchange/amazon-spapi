  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('FreightInformation', function() {
      ...
      it('should create an instance of FreightInformation', function() {
        // TODO: update the code to test FreightInformation
      ...
      it('should have the property freightClass (base name: "freightClass")', function() {
        // TODO: update the code to test the property freightClass
        expect(instance).to.have.property('freightClass');
        // expect(instance.freightClass).to.be(expectedValueLiteral);
      });
