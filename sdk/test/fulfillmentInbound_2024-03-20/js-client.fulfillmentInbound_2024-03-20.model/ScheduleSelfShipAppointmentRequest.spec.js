...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('ScheduleSelfShipAppointmentRequest', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.ScheduleSelfShipAppointmentRequest();
      });

      it('should create an instance of ScheduleSelfShipAppointmentRequest', function() {
        // TODO: update the code to test ScheduleSelfShipAppointmentRequest
      ...
      it('should have the property reasonComment (base name: "reasonComment")', function() {
        // TODO: update the code to test the property reasonComment
        expect(instance).to.have.property('reasonComment');
        // expect(instance.reasonComment).to.be(expectedValueLiteral);
      });
