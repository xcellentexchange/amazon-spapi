...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('GetSelfShipAppointmentSlotsResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.GetSelfShipAppointmentSlotsResponse();
      });

      it('should create an instance of GetSelfShipAppointmentSlotsResponse', function() {
        // TODO: update the code to test GetSelfShipAppointmentSlotsResponse
      ...
      it('should have the property selfShipAppointmentSlotsAvailability (base name: "selfShipAppointmentSlotsAvailability")', function() {
        // TODO: update the code to test the property selfShipAppointmentSlotsAvailability
        expect(instance).to.have.property('selfShipAppointmentSlotsAvailability');
        // expect(instance.selfShipAppointmentSlotsAvailability).to.be(expectedValueLiteral);
      });
