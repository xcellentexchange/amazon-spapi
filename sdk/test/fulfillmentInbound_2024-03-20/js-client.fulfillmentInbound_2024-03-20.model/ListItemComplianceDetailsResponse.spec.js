...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('ListItemComplianceDetailsResponse', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.ListItemComplianceDetailsResponse();
      });

      it('should create an instance of ListItemComplianceDetailsResponse', function() {
        // TODO: update the code to test ListItemComplianceDetailsResponse
      ...
      it('should have the property complianceDetails (base name: "complianceDetails")', function() {
        // TODO: update the code to test the property complianceDetails
        expect(instance).to.have.property('complianceDetails');
        // expect(instance.complianceDetails).to.be(expectedValueLiteral);
      });
