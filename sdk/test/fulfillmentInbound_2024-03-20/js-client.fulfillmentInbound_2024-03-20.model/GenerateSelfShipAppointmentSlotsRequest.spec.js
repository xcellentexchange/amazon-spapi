...
(function(root, factory) {
  ...
  describe('fulfillmentInbound_2024-03-20', function() {
    describe('GenerateSelfShipAppointmentSlotsRequest', function() {
      beforeEach(function() {
        instance = new TheSellingPartnerApiForFbaInboundOperations.GenerateSelfShipAppointmentSlotsRequest();
      });

      it('should create an instance of GenerateSelfShipAppointmentSlotsRequest', function() {
        // TODO: update the code to test GenerateSelfShipAppointmentSlotsRequest
      ...
      it('should have the property desiredEndDate (base name: "desiredEndDate")', function() {
        // TODO: update the code to test the property desiredEndDate
        expect(instance).to.have.property('desiredEndDate');
        // expect(instance.desiredEndDate).to.be(expectedValueLiteral);
      });

      it('should have the property desiredStartDate (base name: "desiredStartDate")', function() {
        // TODO: update the code to test the property desiredStartDate
        expect(instance).to.have.property('desiredStartDate');
        // expect(instance.desiredStartDate).to.be(expectedValueLiteral);
      });
