...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentShippingV1', function() {
    describe('GetPackingSlipListResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentShipping.GetPackingSlipListResponse();
      });

      it('should create an instance of GetPackingSlipListResponse', function() {
        // TODO: update the code to test GetPackingSlipListResponse
        expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentShipping.GetPackingSlipListResponse);
      });
