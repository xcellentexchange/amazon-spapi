...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentShippingV1', function() {
    describe('GetCustomerInvoicesResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentShipping.GetCustomerInvoicesResponse();
      });

      it('should create an instance of GetCustomerInvoicesResponse', function() {
        // TODO: update the code to test GetCustomerInvoicesResponse
        expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentShipping.GetCustomerInvoicesResponse);
      });
