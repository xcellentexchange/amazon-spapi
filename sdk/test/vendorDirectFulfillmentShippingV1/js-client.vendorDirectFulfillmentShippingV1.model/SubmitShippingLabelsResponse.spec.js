...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentShippingV1', function() {
    describe('SubmitShippingLabelsResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentShipping.SubmitShippingLabelsResponse();
      });

      it('should create an instance of SubmitShippingLabelsResponse', function() {
        // TODO: update the code to test SubmitShippingLabelsResponse
        expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentShipping.SubmitShippingLabelsResponse);
      });
