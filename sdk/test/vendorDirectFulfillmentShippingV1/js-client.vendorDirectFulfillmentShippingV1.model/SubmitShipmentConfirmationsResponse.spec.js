...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentShippingV1', function() {
    describe('SubmitShipmentConfirmationsResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentShipping.SubmitShipmentConfirmationsResponse();
      });

      it('should create an instance of SubmitShipmentConfirmationsResponse', function() {
        // TODO: update the code to test SubmitShipmentConfirmationsResponse
        expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentShipping.SubmitShipmentConfirmationsResponse);
      });
