...
(function(root, factory) {
  ...
  describe('productPricing_2022-05-01', function() {
    describe('FeaturedOfferSegment', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.FeaturedOfferSegment();
      });

      it('should create an instance of FeaturedOfferSegment', function() {
        // TODO: update the code to test FeaturedOfferSegment
      ...
      it('should have the property customerMembership (base name: "customerMembership")', function() {
        // TODO: update the code to test the property customerMembership
        expect(instance).to.have.property('customerMembership');
        // expect(instance.customerMembership).to.be(expectedValueLiteral);
      });
