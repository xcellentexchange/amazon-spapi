...
(function(root, factory) {
  ...
  describe('productPricing_2022-05-01', function() {
    describe('CompetitiveSummaryIncludedData', function() {
      beforeEach(function() {
        instance = SellingPartnerApiForPricing.CompetitiveSummaryIncludedData;
      });

      it('should create an instance of CompetitiveSummaryIncludedData', function() {
        // TODO: update the code to test CompetitiveSummaryIncludedData
        expect(instance).to.be.a('object');
      });

      it('should have the property featuredBuyingOptions', function() {
        expect(instance).to.have.property('featuredBuyingOptions');
        expect(instance.featuredBuyingOptions).to.be("featuredBuyingOptions");
      });

      it('should have the property referencePrices', function() {
        expect(instance).to.have.property('referencePrices');
        expect(instance.referencePrices).to.be("referencePrices");
      });

      it('should have the property lowestPricedOffers', function() {
        expect(instance).to.have.property('lowestPricedOffers');
        expect(instance.lowestPricedOffers).to.be("lowestPricedOffers");
      });
