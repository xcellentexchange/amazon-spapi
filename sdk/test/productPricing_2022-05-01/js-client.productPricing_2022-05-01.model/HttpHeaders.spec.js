...
(function(root, factory) {
  ...
  describe('productPricing_2022-05-01', function() {
    describe('HttpHeaders', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.HttpHeaders();
      });

      it('should create an instance of HttpHeaders', function() {
        // TODO: update the code to test HttpHeaders
        expect(instance).to.be.a(SellingPartnerApiForPricing.HttpHeaders);
      });
