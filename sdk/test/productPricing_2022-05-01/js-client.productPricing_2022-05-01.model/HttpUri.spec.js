...
(function(root, factory) {
  ...
  describe('productPricing_2022-05-01', function() {
    describe('HttpUri', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.HttpUri();
      });

      it('should create an instance of HttpUri', function() {
        // TODO: update the code to test HttpUri
        expect(instance).to.be.a(SellingPartnerApiForPricing.HttpUri);
      });
