...
(function(root, factory) {
  ...
  describe('productPricing_2022-05-01', function() {
    describe('CompetitiveSummaryResponse', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.CompetitiveSummaryResponse();
      });

      it('should create an instance of CompetitiveSummaryResponse', function() {
        // TODO: update the code to test CompetitiveSummaryResponse
