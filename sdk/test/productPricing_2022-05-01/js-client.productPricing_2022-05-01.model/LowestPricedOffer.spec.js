...
(function(root, factory) {
  ...
  describe('productPricing_2022-05-01', function() {
    describe('LowestPricedOffer', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForPricing.LowestPricedOffer();
      });

      it('should create an instance of LowestPricedOffer', function() {
        // TODO: update the code to test LowestPricedOffer
      ...
      it('should have the property lowestPricedOffersInput (base name: "lowestPricedOffersInput")', function() {
        // TODO: update the code to test the property lowestPricedOffersInput
        expect(instance).to.have.property('lowestPricedOffersInput');
        // expect(instance.lowestPricedOffersInput).to.be(expectedValueLiteral);
      });
