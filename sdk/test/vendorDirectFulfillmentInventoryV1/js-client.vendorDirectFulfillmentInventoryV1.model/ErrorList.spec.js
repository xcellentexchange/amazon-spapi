...
(function(root, factory) {
  ...
  describe('vendorDirectFulfillmentInventoryV1', function() {
    describe('ErrorList', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForDirectFulfillmentInventoryUpdates.ErrorList();
      });

      it('should create an instance of ErrorList', function() {
        // TODO: update the code to test ErrorList
        expect(instance).to.be.a(SellingPartnerApiForDirectFulfillmentInventoryUpdates.ErrorList);
      });
