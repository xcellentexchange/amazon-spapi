...
(function(root, factory) {
  ...
  describe('catalogItems_2020-12-01', function() {
    describe('ItemVariations', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForCatalogItems.ItemVariations();
      });

      it('should create an instance of ItemVariations', function() {
        // TODO: update the code to test ItemVariations
        expect(instance).to.be.a(SellingPartnerApiForCatalogItems.ItemVariations);
      });
