...
(function(root, factory) {
  ...
  describe('listingsItems_2021-08-01', function() {
    describe('FulfillmentAvailability', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForListingsItems.FulfillmentAvailability();
      });

      it('should create an instance of FulfillmentAvailability', function() {
        // TODO: update the code to test FulfillmentAvailability
      ...
      it('should have the property fulfillmentChannelCode (base name: "fulfillmentChannelCode")', function() {
        // TODO: update the code to test the property fulfillmentChannelCode
        expect(instance).to.have.property('fulfillmentChannelCode');
        // expect(instance.fulfillmentChannelCode).to.be(expectedValueLiteral);
      });
