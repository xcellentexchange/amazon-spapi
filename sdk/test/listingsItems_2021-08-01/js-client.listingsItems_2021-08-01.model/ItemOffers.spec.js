...
(function(root, factory) {
  ...
  describe('listingsItems_2021-08-01', function() {
    describe('ItemOffers', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForListingsItems.ItemOffers();
      });

      it('should create an instance of ItemOffers', function() {
        // TODO: update the code to test ItemOffers
        expect(instance).to.be.a(SellingPartnerApiForListingsItems.ItemOffers);
      });
