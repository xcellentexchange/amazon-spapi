...
(function(root, factory) {
  ...
  describe('listingsItems_2021-08-01', function() {
    describe('ItemIssues', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForListingsItems.ItemIssues();
      });

      it('should create an instance of ItemIssues', function() {
        // TODO: update the code to test ItemIssues
        expect(instance).to.be.a(SellingPartnerApiForListingsItems.ItemIssues);
      });
