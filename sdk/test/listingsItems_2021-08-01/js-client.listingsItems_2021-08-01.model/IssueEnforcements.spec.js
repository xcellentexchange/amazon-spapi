...
(function(root, factory) {
  ...
  describe('listingsItems_2021-08-01', function() {
    describe('IssueEnforcements', function() {
      beforeEach(function() {
        instance = new SellingPartnerApiForListingsItems.IssueEnforcements();
      });

      it('should create an instance of IssueEnforcements', function() {
        // TODO: update the code to test IssueEnforcements
      ...
      it('should have the property exemption (base name: "exemption")', function() {
        // TODO: update the code to test the property exemption
        expect(instance).to.have.property('exemption');
        // expect(instance.exemption).to.be(expectedValueLiteral);
      });
