 ...
 * @module services/js-client.services.model/UpdateReservationRecord
 * @version v1
 */
export class UpdateReservationRecord {
   ...
   * @alias module:services/js-client.services.model/UpdateReservationRecord
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:services/js-client.services.model/UpdateReservationRecord} obj Optional instance to populate.
   * @return {module:services/js-client.services.model/UpdateReservationRecord} The populated <code>UpdateReservationRecord</code> instance.
   */
