 ...
 * @module solicitations/js-client.solicitations.model/CreateProductReviewAndSellerFeedbackSolicitationResponse
 * @version v1
 */
export class CreateProductReviewAndSellerFeedbackSolicitationResponse {
   ...
   * @alias module:solicitations/js-client.solicitations.model/CreateProductReviewAndSellerFeedbackSolicitationResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:solicitations/js-client.solicitations.model/CreateProductReviewAndSellerFeedbackSolicitationResponse} obj Optional instance to populate.
   * @return {module:solicitations/js-client.solicitations.model/CreateProductReviewAndSellerFeedbackSolicitationResponse} The populated <code>CreateProductReviewAndSellerFeedbackSolicitationResponse</code> instance.
   */
