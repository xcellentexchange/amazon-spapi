 ...
 * @module shippingV2/js-client.shippingV2.model/Address
 * @version v2
 */
export class Address {
   ...
   * The address.
   * @alias module:shippingV2/js-client.shippingV2.model/Address
   * @class
   ...
   * @param stateOrRegion {module:shippingV2/js-client.shippingV2.model/StateOrRegion} 
   * @param city {module:shippingV2/js-client.shippingV2.model/City} 
   * @param countryCode {module:shippingV2/js-client.shippingV2.model/CountryCode} 
   * @param postalCode {module:shippingV2/js-client.shippingV2.model/PostalCode} 
   */
   ...
   * @param {module:shippingV2/js-client.shippingV2.model/Address} obj Optional instance to populate.
   * @return {module:shippingV2/js-client.shippingV2.model/Address} The populated <code>Address</code> instance.
   */
...
/**
 * @member {module:shippingV2/js-client.shippingV2.model/Geocode} geocode
 */
