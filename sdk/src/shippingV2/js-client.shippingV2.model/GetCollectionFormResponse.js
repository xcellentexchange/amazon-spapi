 ...
 * @module shippingV2/js-client.shippingV2.model/GetCollectionFormResponse
 * @version v2
 */
export class GetCollectionFormResponse {
   ...
   * @alias module:shippingV2/js-client.shippingV2.model/GetCollectionFormResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shippingV2/js-client.shippingV2.model/GetCollectionFormResponse} obj Optional instance to populate.
   * @return {module:shippingV2/js-client.shippingV2.model/GetCollectionFormResponse} The populated <code>GetCollectionFormResponse</code> instance.
   */
