 ...
 * @module shippingV2/js-client.shippingV2.model/ValidationMetadata
 * @version v2
 */
export class ValidationMetadata {
   ...
   * @alias module:shippingV2/js-client.shippingV2.model/ValidationMetadata
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shippingV2/js-client.shippingV2.model/ValidationMetadata} obj Optional instance to populate.
   * @return {module:shippingV2/js-client.shippingV2.model/ValidationMetadata} The populated <code>ValidationMetadata</code> instance.
   */
