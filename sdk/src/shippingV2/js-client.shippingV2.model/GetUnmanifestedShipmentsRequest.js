 ...
 * @module shippingV2/js-client.shippingV2.model/GetUnmanifestedShipmentsRequest
 * @version v2
 */
export class GetUnmanifestedShipmentsRequest {
   ...
   * @alias module:shippingV2/js-client.shippingV2.model/GetUnmanifestedShipmentsRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shippingV2/js-client.shippingV2.model/GetUnmanifestedShipmentsRequest} obj Optional instance to populate.
   * @return {module:shippingV2/js-client.shippingV2.model/GetUnmanifestedShipmentsRequest} The populated <code>GetUnmanifestedShipmentsRequest</code> instance.
   */
