 ...
 * @module shippingV2/js-client.shippingV2.model/ValueAddedServiceDetails
 * @version v2
 */
export class ValueAddedServiceDetails {
   ...
   * @alias module:shippingV2/js-client.shippingV2.model/ValueAddedServiceDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shippingV2/js-client.shippingV2.model/ValueAddedServiceDetails} obj Optional instance to populate.
   * @return {module:shippingV2/js-client.shippingV2.model/ValueAddedServiceDetails} The populated <code>ValueAddedServiceDetails</code> instance.
   */
...
/**
 * @member {module:shippingV2/js-client.shippingV2.model/CollectOnDelivery} collectOnDelivery
 */
