 ...
 * @module vendorShipments/js-client.vendorShipments.model/Address
 * @version v1
 */
export class Address {
   ...
   * @alias module:vendorShipments/js-client.vendorShipments.model/Address
   * @class
   ...
   * @param {module:vendorShipments/js-client.vendorShipments.model/Address} obj Optional instance to populate.
   * @return {module:vendorShipments/js-client.vendorShipments.model/Address} The populated <code>Address</code> instance.
   */
