 ...
 * @module vendorShipments/js-client.vendorShipments.model/ItemDetails
 * @version v1
 */
export class ItemDetails {
   ...
   * @alias module:vendorShipments/js-client.vendorShipments.model/ItemDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:vendorShipments/js-client.vendorShipments.model/ItemDetails} obj Optional instance to populate.
   * @return {module:vendorShipments/js-client.vendorShipments.model/ItemDetails} The populated <code>ItemDetails</code> instance.
   */
 ...
 * @member {module:vendorShipments/js-client.vendorShipments.model/ItemDetails.HandlingCodeEnum} handlingCode
 */
