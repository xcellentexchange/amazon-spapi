 ...
 * @module fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/PutTransportDetailsResponse
 * @version v0
 */
export class PutTransportDetailsResponse {
  /**
   * Constructs a new <code>PutTransportDetailsResponse</code>.
   * Workflow status for a shipment with an Amazon-partnered carrier.
   * @alias module:fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/PutTransportDetailsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/PutTransportDetailsResponse} obj Optional instance to populate.
   * @return {module:fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/PutTransportDetailsResponse} The populated <code>PutTransportDetailsResponse</code> instance.
   */
 ...
 */
PutTransportDetailsResponse.prototype.payload = undefined;

/**
 * @member {module:fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/ErrorList} errors
 */
PutTransportDetailsResponse.prototype.errors = undefined;
