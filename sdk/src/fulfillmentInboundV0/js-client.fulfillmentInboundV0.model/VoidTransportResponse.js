 ...
 * @module fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/VoidTransportResponse
 * @version v0
 */
export class VoidTransportResponse {
  /**
   * Constructs a new <code>VoidTransportResponse</code>.
   * The response schema for the voidTransport operation.
   * @alias module:fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/VoidTransportResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/VoidTransportResponse} obj Optional instance to populate.
   * @return {module:fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/VoidTransportResponse} The populated <code>VoidTransportResponse</code> instance.
   */
 ...
 */
VoidTransportResponse.prototype.payload = undefined;

/**
 * @member {module:fulfillmentInboundV0/js-client.fulfillmentInboundV0.model/ErrorList} errors
 */
VoidTransportResponse.prototype.errors = undefined;
