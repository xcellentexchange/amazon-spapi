...
export class PatchOperation {
   ...
   * @class
   * @param op {module:listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/PatchOperation.OpEnum} Type of JSON Patch operation. Supported JSON Patch operations include add, replace, and delete. Refer to [JavaScript Object Notation (JSON) Patch](https://tools.ietf.org/html/rfc6902) for more information.
