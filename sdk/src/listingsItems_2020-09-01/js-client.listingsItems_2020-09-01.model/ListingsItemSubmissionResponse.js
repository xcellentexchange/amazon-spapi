 ...
 * @module listingsItems_2020-09-01/js-client.listingsItems_2020-09-01.model/ListingsItemSubmissionResponse
 * @version 2020-09-01
 */
export class ListingsItemSubmissionResponse {
   ...
   * @alias module:listingsItems_2020-09-01/js-client.listingsItems_2020-09-01.model/ListingsItemSubmissionResponse
   * @class
   * @param sku {String} A selling partner provided identifier for an Amazon listing.
   * @param status {module:listingsItems_2020-09-01/js-client.listingsItems_2020-09-01.model/ListingsItemSubmissionResponse.StatusEnum} The status of the listings item submission.
   ...
   * @param {module:listingsItems_2020-09-01/js-client.listingsItems_2020-09-01.model/ListingsItemSubmissionResponse} obj Optional instance to populate.
   * @return {module:listingsItems_2020-09-01/js-client.listingsItems_2020-09-01.model/ListingsItemSubmissionResponse} The populated <code>ListingsItemSubmissionResponse</code> instance.
   */
 ...
 * @member {module:listingsItems_2020-09-01/js-client.listingsItems_2020-09-01.model/ListingsItemSubmissionResponse.StatusEnum} status
 */
 ...
 * @member {Array.<module:listingsItems_2020-09-01/js-client.listingsItems_2020-09-01.model/Issue>} issues
 */
