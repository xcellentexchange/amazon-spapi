 ...
 * @module vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/OrderAcknowledgementItem
 * @version 2021-12-28
 */
export class OrderAcknowledgementItem {
   ...
   * @alias module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/OrderAcknowledgementItem
   * @class
   ...
   * @param acknowledgementStatus {module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/AcknowledgementStatus} Status of acknowledgement.
   * @param sellingParty {module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/PartyIdentification} PartyID as vendor code.
   * @param shipFromParty {module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/PartyIdentification} PartyID as the vendor's warehouseId.
   * @param itemAcknowledgements {Array.<module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/OrderItemAcknowledgement>} Item details including acknowledged quantity.
   */
   ...
   * @param {module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/OrderAcknowledgementItem} obj Optional instance to populate.
   * @return {module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/OrderAcknowledgementItem} The populated <code>OrderAcknowledgementItem</code> instance.
   */
 ...
 * @member {module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/AcknowledgementStatus} acknowledgementStatus
 */
 ...
 * @member {Array.<module:vendorDirectFulfillmentOrders_2021-12-28/js-client.vendorDirectFulfillmentOrders_2021-12-28.model/OrderItemAcknowledgement>} itemAcknowledgements
 */
