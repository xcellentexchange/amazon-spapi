 ...
 * @module vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/TaxRegistrationDetails
 * @version v1
 */
export class TaxRegistrationDetails {
   ...
   * @alias module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/TaxRegistrationDetails
   * @class
   ...
   * @param {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/TaxRegistrationDetails} obj Optional instance to populate.
   * @return {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/TaxRegistrationDetails} The populated <code>TaxRegistrationDetails</code> instance.
   */
 ...
 * @member {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/TaxRegistrationDetails.TaxRegistrationTypeEnum} taxRegistrationType
 */
 ...
 * @member {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/Address} taxRegistrationAddress
 */
