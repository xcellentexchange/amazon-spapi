 ...
 * @module vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/ShipmentDates
 * @version v1
 */
export class ShipmentDates {
   ...
   * Shipment dates.
   * @alias module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/ShipmentDates
   * @class
   ...
   * @param {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/ShipmentDates} obj Optional instance to populate.
   * @return {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/ShipmentDates} The populated <code>ShipmentDates</code> instance.
   */
