...
const OrderChangeTypeEnum = {
   ...
   * @return {module:notifications/js-client.notifications.model/OrderChangeTypeEnum} The enum <code>OrderChangeTypeEnum</code> value.
   */
