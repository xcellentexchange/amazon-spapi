 ...
 * @module fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/CancelFulfillmentOrderResponse
 * @version 2020-07-01
 */
export class CancelFulfillmentOrderResponse {
   ...
   * @alias module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/CancelFulfillmentOrderResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/CancelFulfillmentOrderResponse} obj Optional instance to populate.
   * @return {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/CancelFulfillmentOrderResponse} The populated <code>CancelFulfillmentOrderResponse</code> instance.
   */
