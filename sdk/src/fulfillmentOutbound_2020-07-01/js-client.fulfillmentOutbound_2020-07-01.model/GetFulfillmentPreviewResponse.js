 ...
 * @module fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFulfillmentPreviewResponse
 * @version 2020-07-01
 */
export class GetFulfillmentPreviewResponse {
   ...
   * @alias module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFulfillmentPreviewResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFulfillmentPreviewResponse} obj Optional instance to populate.
   * @return {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFulfillmentPreviewResponse} The populated <code>GetFulfillmentPreviewResponse</code> instance.
   */
 ...
 * @member {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFulfillmentPreviewResult} payload
 */
