 ...
 * @module fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFeaturesResponse
 * @version 2020-07-01
 */
export class GetFeaturesResponse {
   ...
   * @alias module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFeaturesResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFeaturesResponse} obj Optional instance to populate.
   * @return {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFeaturesResponse} The populated <code>GetFeaturesResponse</code> instance.
   */
...
/**
 * @member {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/GetFeaturesResult} payload
 */
