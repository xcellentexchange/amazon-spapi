 ...
 * @module catalogItems_2020-12-01/js-client.catalogItems_2020-12-01.model/ItemProductTypeByMarketplace
 * @version 2020-12-01
 */
export class ItemProductTypeByMarketplace {
   ...
   * @alias module:catalogItems_2020-12-01/js-client.catalogItems_2020-12-01.model/ItemProductTypeByMarketplace
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:catalogItems_2020-12-01/js-client.catalogItems_2020-12-01.model/ItemProductTypeByMarketplace} obj Optional instance to populate.
   * @return {module:catalogItems_2020-12-01/js-client.catalogItems_2020-12-01.model/ItemProductTypeByMarketplace} The populated <code>ItemProductTypeByMarketplace</code> instance.
   */
