 ...
 * @module vendorOrders/js-client.vendorOrders.model/TaxRegistrationDetails
 * @version v1
 */
export class TaxRegistrationDetails {
   ...
   * @alias module:vendorOrders/js-client.vendorOrders.model/TaxRegistrationDetails
   * @class
   * @param taxRegistrationType {module:vendorOrders/js-client.vendorOrders.model/TaxRegistrationDetails.TaxRegistrationTypeEnum} Tax registration type for the entity.
   ...
   * @param {module:vendorOrders/js-client.vendorOrders.model/TaxRegistrationDetails} obj Optional instance to populate.
   * @return {module:vendorOrders/js-client.vendorOrders.model/TaxRegistrationDetails} The populated <code>TaxRegistrationDetails</code> instance.
   */
 ...
 * @member {module:vendorOrders/js-client.vendorOrders.model/TaxRegistrationDetails.TaxRegistrationTypeEnum} taxRegistrationType
 */
