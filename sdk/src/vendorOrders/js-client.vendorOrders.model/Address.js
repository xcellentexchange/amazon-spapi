 ...
 * @module vendorOrders/js-client.vendorOrders.model/Address
 * @version v1
 */
export class Address {
   ...
   * @alias module:vendorOrders/js-client.vendorOrders.model/Address
   * @class
   ...
   * @param {module:vendorOrders/js-client.vendorOrders.model/Address} obj Optional instance to populate.
   * @return {module:vendorOrders/js-client.vendorOrders.model/Address} The populated <code>Address</code> instance.
   */
