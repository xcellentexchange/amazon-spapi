 ...
 * @module messaging/js-client.messaging.model/CreateConfirmOrderDetailsResponse
 * @version v1
 */
export class CreateConfirmOrderDetailsResponse {
   ...
   * @alias module:messaging/js-client.messaging.model/CreateConfirmOrderDetailsResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:messaging/js-client.messaging.model/CreateConfirmOrderDetailsResponse} obj Optional instance to populate.
   * @return {module:messaging/js-client.messaging.model/CreateConfirmOrderDetailsResponse} The populated <code>CreateConfirmOrderDetailsResponse</code> instance.
   */
