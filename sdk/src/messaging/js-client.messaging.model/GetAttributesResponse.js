 ...
 * @module messaging/js-client.messaging.model/GetAttributesResponse
 * @version v1
 */
export class GetAttributesResponse {
   ...
   * @alias module:messaging/js-client.messaging.model/GetAttributesResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:messaging/js-client.messaging.model/GetAttributesResponse} obj Optional instance to populate.
   * @return {module:messaging/js-client.messaging.model/GetAttributesResponse} The populated <code>GetAttributesResponse</code> instance.
   */
...
/**
 * @member {module:messaging/js-client.messaging.model/GetAttributesResponseBuyer} buyer
 */
