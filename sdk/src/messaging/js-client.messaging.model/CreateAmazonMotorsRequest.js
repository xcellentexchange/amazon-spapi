 ...
 * @module messaging/js-client.messaging.model/CreateAmazonMotorsRequest
 * @version v1
 */
export class CreateAmazonMotorsRequest {
   ...
   * @alias module:messaging/js-client.messaging.model/CreateAmazonMotorsRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:messaging/js-client.messaging.model/CreateAmazonMotorsRequest} obj Optional instance to populate.
   * @return {module:messaging/js-client.messaging.model/CreateAmazonMotorsRequest} The populated <code>CreateAmazonMotorsRequest</code> instance.
   */
