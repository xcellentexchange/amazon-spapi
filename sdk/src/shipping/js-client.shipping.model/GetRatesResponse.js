 ...
 * @module shipping/js-client.shipping.model/GetRatesResponse
 * @version v1
 */
export class GetRatesResponse {
   ...
   * @alias module:shipping/js-client.shipping.model/GetRatesResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shipping/js-client.shipping.model/GetRatesResponse} obj Optional instance to populate.
   * @return {module:shipping/js-client.shipping.model/GetRatesResponse} The populated <code>GetRatesResponse</code> instance.
   */
 ...
 * @member {module:shipping/js-client.shipping.model/GetRatesResult} payload
 */
 ...
 */
GetRatesResponse.prototype.errors = undefined;
