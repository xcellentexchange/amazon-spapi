 ...
 * @module shipping/js-client.shipping.model/GetAccountResponse
 * @version v1
 */
export class GetAccountResponse {
   ...
   * @alias module:shipping/js-client.shipping.model/GetAccountResponse
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shipping/js-client.shipping.model/GetAccountResponse} obj Optional instance to populate.
   * @return {module:shipping/js-client.shipping.model/GetAccountResponse} The populated <code>GetAccountResponse</code> instance.
   */
 ...
 * @member {module:shipping/js-client.shipping.model/Account} payload
 */
