 ...
 * @module shipping/js-client.shipping.model/Label
 * @version v1
 */
export class Label {
  /**
   ...
   * @alias module:shipping/js-client.shipping.model/Label
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shipping/js-client.shipping.model/Label} obj Optional instance to populate.
   * @return {module:shipping/js-client.shipping.model/Label} The populated <code>Label</code> instance.
   */
